var R4=globalThis,r4=R4.ShadowRoot&&(R4.ShadyCSS===void 0||R4.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,p4=Symbol(),N3=new WeakMap;class l4{constructor(Q,Y,G){if(this._$cssResult$=!0,G!==p4)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=Q,this._strings=Y}get styleSheet(){let Q=this._styleSheet,Y=this._strings;if(r4&&Q===void 0){let G=Y!==void 0&&Y.length===1;if(G)Q=N3.get(Y);if(Q===void 0){if((this._styleSheet=Q=new CSSStyleSheet).replaceSync(this.cssText),G)N3.set(Y,Q)}}return Q}toString(){return this.cssText}}var NQ=(Q)=>{if(Q._$cssResult$===!0)return Q.cssText;else if(typeof Q==="number")return Q;else throw Error(`Value passed to 'css' function must be a 'css' function result: ${Q}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},OQ=(Q)=>new l4(typeof Q==="string"?Q:String(Q),void 0,p4),L=(Q,...Y)=>{let G=Q.length===1?Q[0]:Y.reduce((X,K,B)=>X+NQ(K)+Q[B+1],Q[0]);return new l4(G,Q,p4)},O3=(Q,Y)=>{if(r4)Q.adoptedStyleSheets=Y.map((G)=>G instanceof CSSStyleSheet?G:G.styleSheet);else for(let G of Y){let X=document.createElement("style"),K=R4.litNonce;if(K!==void 0)X.setAttribute("nonce",K);X.textContent=G.cssText,Q.appendChild(X)}},PQ=(Q)=>{let Y="";for(let G of Q.cssRules)Y+=G.cssText;return OQ(Y)},d4=r4?(Q)=>Q:(Q)=>Q instanceof CSSStyleSheet?PQ(Q):Q;var{is:EQ,defineProperty:MQ,getOwnPropertyDescriptor:P3,getOwnPropertyNames:ZQ,getOwnPropertySymbols:RQ,getPrototypeOf:E3}=Object,_Q=!1,R=globalThis;if(_Q)R.customElements??=customElements;var _=!0,C,M3=R.trustedTypes,wQ=M3?M3.emptyScript:"",R3=_?R.reactiveElementPolyfillSupportDevMode:R.reactiveElementPolyfillSupport;if(_)R.litIssuedWarnings??=new Set,C=(Q,Y)=>{if(Y+=` See https://lit.dev/msg/${Q} for more information.`,!R.litIssuedWarnings.has(Y)&&!R.litIssuedWarnings.has(Q))console.warn(Y),R.litIssuedWarnings.add(Y)},queueMicrotask(()=>{if(C("dev-mode","Lit is in dev mode. Not recommended for production!"),R.ShadyDOM?.inUse&&R3===void 0)C("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});var TQ=_?(Q)=>{if(!R.emitLitDebugLogEvents)return;R.dispatchEvent(new CustomEvent("lit-debug",{detail:Q}))}:void 0,a=(Q,Y)=>Q,n4={toAttribute(Q,Y){switch(Y){case Boolean:Q=Q?wQ:null;break;case Object:case Array:Q=Q==null?Q:JSON.stringify(Q);break}return Q},fromAttribute(Q,Y){let G=Q;switch(Y){case Boolean:G=Q!==null;break;case Number:G=Q===null?null:Number(Q);break;case Object:case Array:try{G=JSON.parse(Q)}catch(X){G=null}break}return G}},_3=(Q,Y)=>!EQ(Q,Y),Z3={attribute:!0,type:String,converter:n4,reflect:!1,useDefault:!1,hasChanged:_3};Symbol.metadata??=Symbol("metadata");R.litPropertyMetadata??=new WeakMap;class w extends HTMLElement{static addInitializer(Q){this.__prepare(),(this._initializers??=[]).push(Q)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(Q,Y=Z3){if(Y.state)Y.attribute=!1;if(this.__prepare(),this.prototype.hasOwnProperty(Q))Y=Object.create(Y),Y.wrapped=!0;if(this.elementProperties.set(Q,Y),!Y.noAccessor){let G=_?Symbol.for(`${String(Q)} (@property() cache)`):Symbol(),X=this.getPropertyDescriptor(Q,G,Y);if(X!==void 0)MQ(this.prototype,Q,X)}}static getPropertyDescriptor(Q,Y,G){let{get:X,set:K}=P3(this.prototype,Q)??{get(){return this[Y]},set(B){this[Y]=B}};if(_&&X==null){if("value"in(P3(this.prototype,Q)??{}))throw Error(`Field ${JSON.stringify(String(Q))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);C("reactive-property-without-getter",`Field ${JSON.stringify(String(Q))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:X,set(B){let J=X?.call(this);K?.call(this,B),this.requestUpdate(Q,J,G)},configurable:!0,enumerable:!0}}static getPropertyOptions(Q){return this.elementProperties.get(Q)??Z3}static __prepare(){if(this.hasOwnProperty(a("elementProperties",this)))return;let Q=E3(this);if(Q.finalize(),Q._initializers!==void 0)this._initializers=[...Q._initializers];this.elementProperties=new Map(Q.elementProperties)}static finalize(){if(this.hasOwnProperty(a("finalized",this)))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(a("properties",this))){let Y=this.properties,G=[...ZQ(Y),...RQ(Y)];for(let X of G)this.createProperty(X,Y[X])}let Q=this[Symbol.metadata];if(Q!==null){let Y=litPropertyMetadata.get(Q);if(Y!==void 0)for(let[G,X]of Y)this.elementProperties.set(G,X)}this.__attributeToPropertyMap=new Map;for(let[Y,G]of this.elementProperties){let X=this.__attributeNameForProperty(Y,G);if(X!==void 0)this.__attributeToPropertyMap.set(X,Y)}if(this.elementStyles=this.finalizeStyles(this.styles),_){if(this.hasOwnProperty("createProperty"))C("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators");if(this.hasOwnProperty("getPropertyDescriptor"))C("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}}static finalizeStyles(Q){let Y=[];if(Array.isArray(Q)){let G=new Set(Q.flat(1/0).reverse());for(let X of G)Y.unshift(d4(X))}else if(Q!==void 0)Y.push(d4(Q));return Y}static __attributeNameForProperty(Q,Y){let G=Y.attribute;return G===!1?void 0:typeof G==="string"?G:typeof Q==="string"?Q.toLowerCase():void 0}constructor(){super();this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise((Q)=>this.enableUpdating=Q),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach((Q)=>Q(this))}addController(Q){if((this.__controllers??=new Set).add(Q),this.renderRoot!==void 0&&this.isConnected)Q.hostConnected?.()}removeController(Q){this.__controllers?.delete(Q)}__saveInstanceProperties(){let Q=new Map,Y=this.constructor.elementProperties;for(let G of Y.keys())if(this.hasOwnProperty(G))Q.set(G,this[G]),delete this[G];if(Q.size>0)this.__instanceProperties=Q}createRenderRoot(){let Q=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return O3(Q,this.constructor.elementStyles),Q}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach((Q)=>Q.hostConnected?.())}enableUpdating(Q){}disconnectedCallback(){this.__controllers?.forEach((Q)=>Q.hostDisconnected?.())}attributeChangedCallback(Q,Y,G){this._$attributeToProperty(Q,G)}__propertyToAttribute(Q,Y){let X=this.constructor.elementProperties.get(Q),K=this.constructor.__attributeNameForProperty(Q,X);if(K!==void 0&&X.reflect===!0){let J=(X.converter?.toAttribute!==void 0?X.converter:n4).toAttribute(Y,X.type);if(_&&this.constructor.enabledWarnings.includes("migration")&&J===void 0)C("undefined-attribute-value",`The attribute value for the ${Q} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`);if(this.__reflectingProperty=Q,J==null)this.removeAttribute(K);else this.setAttribute(K,J);this.__reflectingProperty=null}}_$attributeToProperty(Q,Y){let G=this.constructor,X=G.__attributeToPropertyMap.get(Q);if(X!==void 0&&this.__reflectingProperty!==X){let K=G.getPropertyOptions(X),B=typeof K.converter==="function"?{fromAttribute:K.converter}:K.converter?.fromAttribute!==void 0?K.converter:n4;this.__reflectingProperty=X;let J=B.fromAttribute(Y,K.type);this[X]=J??this.__defaultValues?.get(X)??J,this.__reflectingProperty=null}}requestUpdate(Q,Y,G,X=!1,K){if(Q!==void 0){if(_&&Q instanceof Event)C("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");let B=this.constructor;if(X===!1)K=this[Q];if(G??=B.getPropertyOptions(Q),(G.hasChanged??_3)(K,Y)||G.useDefault&&G.reflect&&K===this.__defaultValues?.get(Q)&&!this.hasAttribute(B.__attributeNameForProperty(Q,G)))this._$changeProperty(Q,Y,G);else return}if(this.isUpdatePending===!1)this.__updatePromise=this.__enqueueUpdate()}_$changeProperty(Q,Y,{useDefault:G,reflect:X,wrapped:K},B){if(G&&!(this.__defaultValues??=new Map).has(Q)){if(this.__defaultValues.set(Q,B??Y??this[Q]),K!==!0||B!==void 0)return}if(!this._$changedProperties.has(Q)){if(!this.hasUpdated&&!G)Y=void 0;this._$changedProperties.set(Q,Y)}if(X===!0&&this.__reflectingProperty!==Q)(this.__reflectingProperties??=new Set).add(Q)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(Y){Promise.reject(Y)}let Q=this.scheduleUpdate();if(Q!=null)await Q;return!this.isUpdatePending}scheduleUpdate(){let Q=this.performUpdate();if(_&&this.constructor.enabledWarnings.includes("async-perform-update")&&typeof Q?.then==="function")C("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`);return Q}performUpdate(){if(!this.isUpdatePending)return;if(TQ?.({kind:"update"}),!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),_){let K=[...this.constructor.elementProperties.keys()].filter((B)=>this.hasOwnProperty(B)&&(B in E3(this)));if(K.length)throw Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${K.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(let[X,K]of this.__instanceProperties)this[X]=K;this.__instanceProperties=void 0}let G=this.constructor.elementProperties;if(G.size>0)for(let[X,K]of G){let{wrapped:B}=K,J=this[X];if(B===!0&&!this._$changedProperties.has(X)&&J!==void 0)this._$changeProperty(X,void 0,K,J)}}let Q=!1,Y=this._$changedProperties;try{if(Q=this.shouldUpdate(Y),Q)this.willUpdate(Y),this.__controllers?.forEach((G)=>G.hostUpdate?.()),this.update(Y);else this.__markUpdated()}catch(G){throw Q=!1,this.__markUpdated(),G}if(Q)this._$didUpdate(Y)}willUpdate(Q){}_$didUpdate(Q){if(this.__controllers?.forEach((Y)=>Y.hostUpdated?.()),!this.hasUpdated)this.hasUpdated=!0,this.firstUpdated(Q);if(this.updated(Q),_&&this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update"))C("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(Q){return!0}update(Q){this.__reflectingProperties&&=this.__reflectingProperties.forEach((Y)=>this.__propertyToAttribute(Y,this[Y])),this.__markUpdated()}updated(Q){}firstUpdated(Q){}}w.elementStyles=[];w.shadowRootOptions={mode:"open"};w[a("elementProperties",w)]=new Map;w[a("finalized",w)]=new Map;R3?.({ReactiveElement:w});if(_){w.enabledWarnings=["change-in-update","async-perform-update"];let Q=function(Y){if(!Y.hasOwnProperty(a("enabledWarnings",Y)))Y.enabledWarnings=Y.enabledWarnings.slice()};w.enableWarning=function(Y){if(Q(this),!this.enabledWarnings.includes(Y))this.enabledWarnings.push(Y)},w.disableWarning=function(Y){Q(this);let G=this.enabledWarnings.indexOf(Y);if(G>=0)this.enabledWarnings.splice(G,1)}}(R.reactiveElementVersions??=[]).push("2.1.2");if(_&&R.reactiveElementVersions.length>1)queueMicrotask(()=>{C("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var T=globalThis,V=(Q)=>{if(!T.emitLitDebugLogEvents)return;T.dispatchEvent(new CustomEvent("lit-debug",{detail:Q}))},SQ=0,j4;T.litIssuedWarnings??=new Set,j4=(Q,Y)=>{if(Y+=Q?` See https://lit.dev/msg/${Q} for more information.`:"",!T.litIssuedWarnings.has(Y)&&!T.litIssuedWarnings.has(Q))console.warn(Y),T.litIssuedWarnings.add(Y)},queueMicrotask(()=>{j4("dev-mode","Lit is in dev mode. Not recommended for production!")});var k=T.ShadyDOM?.inUse&&T.ShadyDOM?.noPatch===!0?T.ShadyDOM.wrap:(Q)=>Q,_4=T.trustedTypes,w3=_4?_4.createPolicy("lit-html",{createHTML:(Q)=>Q}):void 0,bQ=(Q)=>Q,b4=(Q,Y,G)=>bQ,CQ=(Q)=>{if(i!==b4)throw Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");i=Q},kQ=()=>{i=b4},e4=(Q,Y,G)=>{return i(Q,Y,G)},g3="$lit$",c=`lit$${Math.random().toFixed(9).slice(2)}$`,v3="?"+c,xQ=`<${v3}>`,d=document,$4=()=>d.createComment(""),A4=(Q)=>Q===null||typeof Q!="object"&&typeof Q!="function",Q3=Array.isArray,gQ=(Q)=>Q3(Q)||typeof Q?.[Symbol.iterator]==="function",i4=`[ 	
\f\r]`,vQ=`[^ 	
\f\r"'\`<>=]`,hQ=`[^\\s"'>=/]`,W4=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,T3=1,s4=2,cQ=3,S3=/-->/g,b3=/>/g,r=new RegExp(`>|${i4}(?:(${hQ}+)(${i4}*=${i4}*(?:${vQ}|("|')|))|$)`,"g"),yQ=0,C3=1,mQ=2,k3=3,t4=/'/g,a4=/"/g,h3=/^(?:script|style|textarea|title)$/i,uQ=1,w4=2,T4=3,Y3=1,S4=2,fQ=3,oQ=4,rQ=5,G3=6,pQ=7,X3=(Q)=>(Y,...G)=>{if(Y.some((X)=>X===void 0))console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`);if(G.some((X)=>X?._$litStatic$))j4("",`Static values 'literal' or 'unsafeStatic' cannot be used as values to non-static templates.
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:Q,strings:Y,values:G}},q=X3(uQ),S=X3(w4),m8=X3(T4),n=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),x3=new WeakMap,l=d.createTreeWalker(d,129),i=b4;function c3(Q,Y){if(!Q3(Q)||!Q.hasOwnProperty("raw")){let G="invalid template strings array";throw G=`
        ...
        `.trim().replace(/\n */g,`
`),Error(G)}return w3!==void 0?w3.createHTML(Y):Y}var lQ=(Q,Y)=>{let G=Q.length-1,X=[],K=Y===w4?"<svg>":Y===T4?"<math>":"",B,J=W4;for(let U=0;U<G;U++){let W=Q[U],j=-1,D,I=0,F;while(I<W.length){if(J.lastIndex=I,F=J.exec(W),F===null)break;if(I=J.lastIndex,J===W4){if(F[T3]==="!--")J=S3;else if(F[T3]!==void 0)J=b3;else if(F[s4]!==void 0){if(h3.test(F[s4]))B=new RegExp(`</${F[s4]}`,"g");J=r}else if(F[cQ]!==void 0)throw Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else if(J===r)if(F[yQ]===">")J=B??W4,j=-1;else if(F[C3]===void 0)j=-2;else j=J.lastIndex-F[mQ].length,D=F[C3],J=F[k3]===void 0?r:F[k3]==='"'?a4:t4;else if(J===a4||J===t4)J=r;else if(J===S3||J===b3)J=W4;else J=r,B=void 0}console.assert(j===-1||J===r||J===t4||J===a4,"unexpected parse state B");let P=J===r&&Q[U+1].startsWith("/>")?" ":"";K+=J===W4?W+xQ:j>=0?(X.push(D),W.slice(0,j)+g3+W.slice(j))+c+P:W+c+(j===-2?U:P)}let H=K+(Q[G]||"<?>")+(Y===w4?"</svg>":Y===T4?"</math>":"");return[c3(Q,H),X]};class D4{constructor({strings:Q,["_$litType$"]:Y},G){this.parts=[];let X,K=0,B=0,J=Q.length-1,H=this.parts,[U,W]=lQ(Q,Y);if(this.el=D4.createElement(U,G),l.currentNode=this.el.content,Y===w4||Y===T4){let j=this.el.content.firstChild;j.replaceWith(...j.childNodes)}while((X=l.nextNode())!==null&&H.length<J){if(X.nodeType===1){{let j=X.localName;if(/^(?:textarea|template)$/i.test(j)&&X.innerHTML.includes(c)){let D=`Expressions are not supported inside \`${j}\` elements. See https://lit.dev/msg/expression-in-${j} for more information.`;if(j==="template")throw Error(D);else j4("",D)}}if(X.hasAttributes()){for(let j of X.getAttributeNames())if(j.endsWith(g3)){let D=W[B++],F=X.getAttribute(j).split(c),P=/([.?@])?(.*)/.exec(D);H.push({type:Y3,index:K,name:P[2],strings:F,ctor:P[1]==="."?m3:P[1]==="?"?u3:P[1]==="@"?f3:F4}),X.removeAttribute(j)}else if(j.startsWith(c))H.push({type:G3,index:K}),X.removeAttribute(j)}if(h3.test(X.tagName)){let j=X.textContent.split(c),D=j.length-1;if(D>0){X.textContent=_4?_4.emptyScript:"";for(let I=0;I<D;I++)X.append(j[I],$4()),l.nextNode(),H.push({type:S4,index:++K});X.append(j[D],$4())}}}else if(X.nodeType===8)if(X.data===v3)H.push({type:S4,index:K});else{let D=-1;while((D=X.data.indexOf(c,D+1))!==-1)H.push({type:pQ,index:K}),D+=c.length-1}K++}if(W.length!==B)throw Error('Detected duplicate attribute bindings. This occurs if your template has duplicate attributes on an element tag. For example "<input ?disabled=${true} ?disabled=${false}>" contains a duplicate "disabled" attribute. The error was detected in the following template: \n`'+Q.join("${...}")+"`");V&&V({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:Q})}static createElement(Q,Y){let G=d.createElement("template");return G.innerHTML=Q,G}}function e(Q,Y,G=Q,X){if(Y===n)return Y;let K=X!==void 0?G.__directives?.[X]:G.__directive,B=A4(Y)?void 0:Y._$litDirective$;if(K?.constructor!==B){if(K?._$notifyDirectiveConnectionChanged?.(!1),B===void 0)K=void 0;else K=new B(Q),K._$initialize(Q,G,X);if(X!==void 0)(G.__directives??=[])[X]=K;else G.__directive=K}if(K!==void 0)Y=e(Q,K._$resolve(Q,Y.values),K,X);return Y}class y3{constructor(Q,Y){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=Q,this._$parent=Y}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(Q){let{el:{content:Y},parts:G}=this._$template,X=(Q?.creationScope??d).importNode(Y,!0);l.currentNode=X;let K=l.nextNode(),B=0,J=0,H=G[0];while(H!==void 0){if(B===H.index){let U;if(H.type===S4)U=new L4(K,K.nextSibling,this,Q);else if(H.type===Y3)U=new H.ctor(K,H.name,H.strings,this,Q);else if(H.type===G3)U=new o3(K,this,Q);this._$parts.push(U),H=G[++J]}if(B!==H?.index)K=l.nextNode(),B++}return l.currentNode=d,X}_update(Q){let Y=0;for(let G of this._$parts){if(G!==void 0)if(V&&V({kind:"set part",part:G,value:Q[Y],valueIndex:Y,values:Q,templateInstance:this}),G.strings!==void 0)G._$setValue(Q,G,Y),Y+=G.strings.length-2;else G._$setValue(Q[Y]);Y++}}}class L4{get _$isConnected(){return this._$parent?._$isConnected??this.__isConnected}constructor(Q,Y,G,X){this.type=S4,this._$committedValue=z,this._$disconnectableChildren=void 0,this._$startNode=Q,this._$endNode=Y,this._$parent=G,this.options=X,this.__isConnected=X?.isConnected??!0,this._textSanitizer=void 0}get parentNode(){let Q=k(this._$startNode).parentNode,Y=this._$parent;if(Y!==void 0&&Q?.nodeType===11)Q=Y.parentNode;return Q}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(Q,Y=this){if(this.parentNode===null)throw Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(Q=e(this,Q,Y),A4(Q)){if(Q===z||Q==null||Q===""){if(this._$committedValue!==z)V&&V({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear();this._$committedValue=z}else if(Q!==this._$committedValue&&Q!==n)this._commitText(Q)}else if(Q._$litType$!==void 0)this._commitTemplateResult(Q);else if(Q.nodeType!==void 0){if(this.options?.host===Q){this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),console.warn("Attempted to render the template host",Q,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");return}this._commitNode(Q)}else if(gQ(Q))this._commitIterable(Q);else this._commitText(Q)}_insert(Q){return k(k(this._$startNode).parentNode).insertBefore(Q,this._$endNode)}_commitNode(Q){if(this._$committedValue!==Q){if(this._$clear(),i!==b4){let Y=this._$startNode.parentNode?.nodeName;if(Y==="STYLE"||Y==="SCRIPT"){let G="Forbidden";if(Y==="STYLE")G="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.";else G="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.";throw Error(G)}}V&&V({kind:"commit node",start:this._$startNode,parent:this._$parent,value:Q,options:this.options}),this._$committedValue=this._insert(Q)}}_commitText(Q){if(this._$committedValue!==z&&A4(this._$committedValue)){let Y=k(this._$startNode).nextSibling;if(this._textSanitizer===void 0)this._textSanitizer=e4(Y,"data","property");Q=this._textSanitizer(Q),V&&V({kind:"commit text",node:Y,value:Q,options:this.options}),Y.data=Q}else{let Y=d.createTextNode("");if(this._commitNode(Y),this._textSanitizer===void 0)this._textSanitizer=e4(Y,"data","property");Q=this._textSanitizer(Q),V&&V({kind:"commit text",node:Y,value:Q,options:this.options}),Y.data=Q}this._$committedValue=Q}_commitTemplateResult(Q){let{values:Y,["_$litType$"]:G}=Q,X=typeof G==="number"?this._$getTemplate(Q):(G.el===void 0&&(G.el=D4.createElement(c3(G.h,G.h[0]),this.options)),G);if(this._$committedValue?._$template===X)V&&V({kind:"template updating",template:X,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:Y}),this._$committedValue._update(Y);else{let K=new y3(X,this),B=K._clone(this.options);V&&V({kind:"template instantiated",template:X,instance:K,parts:K._$parts,options:this.options,fragment:B,values:Y}),K._update(Y),V&&V({kind:"template instantiated and updated",template:X,instance:K,parts:K._$parts,options:this.options,fragment:B,values:Y}),this._commitNode(B),this._$committedValue=K}}_$getTemplate(Q){let Y=x3.get(Q.strings);if(Y===void 0)x3.set(Q.strings,Y=new D4(Q));return Y}_commitIterable(Q){if(!Q3(this._$committedValue))this._$committedValue=[],this._$clear();let Y=this._$committedValue,G=0,X;for(let K of Q){if(G===Y.length)Y.push(X=new L4(this._insert($4()),this._insert($4()),this,this.options));else X=Y[G];X._$setValue(K),G++}if(G<Y.length)this._$clear(X&&k(X._$endNode).nextSibling,G),Y.length=G}_$clear(Q=k(this._$startNode).nextSibling,Y){this._$notifyConnectionChanged?.(!1,!0,Y);while(Q!==this._$endNode){let G=k(Q).nextSibling;k(Q).remove(),Q=G}}setConnected(Q){if(this._$parent===void 0)this.__isConnected=Q,this._$notifyConnectionChanged?.(Q);else throw Error("part.setConnected() may only be called on a RootPart returned from render().")}}class F4{get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}constructor(Q,Y,G,X,K){if(this.type=Y3,this._$committedValue=z,this._$disconnectableChildren=void 0,this.element=Q,this.name=Y,this._$parent=X,this.options=K,G.length>2||G[0]!==""||G[1]!=="")this._$committedValue=Array(G.length-1).fill(new String),this.strings=G;else this._$committedValue=z;this._sanitizer=void 0}_$setValue(Q,Y=this,G,X){let K=this.strings,B=!1;if(K===void 0){if(Q=e(this,Q,Y,0),B=!A4(Q)||Q!==this._$committedValue&&Q!==n,B)this._$committedValue=Q}else{let J=Q;Q=K[0];let H,U;for(H=0;H<K.length-1;H++){if(U=e(this,J[G+H],Y,H),U===n)U=this._$committedValue[H];if(B||=!A4(U)||U!==this._$committedValue[H],U===z)Q=z;else if(Q!==z)Q+=(U??"")+K[H+1];this._$committedValue[H]=U}}if(B&&!X)this._commitValue(Q)}_commitValue(Q){if(Q===z)k(this.element).removeAttribute(this.name);else{if(this._sanitizer===void 0)this._sanitizer=i(this.element,this.name,"attribute");Q=this._sanitizer(Q??""),V&&V({kind:"commit attribute",element:this.element,name:this.name,value:Q,options:this.options}),k(this.element).setAttribute(this.name,Q??"")}}}class m3 extends F4{constructor(){super(...arguments);this.type=fQ}_commitValue(Q){if(this._sanitizer===void 0)this._sanitizer=i(this.element,this.name,"property");Q=this._sanitizer(Q),V&&V({kind:"commit property",element:this.element,name:this.name,value:Q,options:this.options}),this.element[this.name]=Q===z?void 0:Q}}class u3 extends F4{constructor(){super(...arguments);this.type=oQ}_commitValue(Q){V&&V({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(Q&&Q!==z),options:this.options}),k(this.element).toggleAttribute(this.name,!!Q&&Q!==z)}}class f3 extends F4{constructor(Q,Y,G,X,K){super(Q,Y,G,X,K);if(this.type=rQ,this.strings!==void 0)throw Error(`A \`<${Q.localName}>\` has a \`@${Y}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(Q,Y=this){if(Q=e(this,Q,Y,0)??z,Q===n)return;let G=this._$committedValue,X=Q===z&&G!==z||Q.capture!==G.capture||Q.once!==G.once||Q.passive!==G.passive,K=Q!==z&&(G===z||X);if(V&&V({kind:"commit event listener",element:this.element,name:this.name,value:Q,options:this.options,removeListener:X,addListener:K,oldListener:G}),X)this.element.removeEventListener(this.name,this,G);if(K)this.element.addEventListener(this.name,this,Q);this._$committedValue=Q}handleEvent(Q){if(typeof this._$committedValue==="function")this._$committedValue.call(this.options?.host??this.element,Q);else this._$committedValue.handleEvent(Q)}}class o3{constructor(Q,Y,G){this.element=Q,this.type=G3,this._$disconnectableChildren=void 0,this._$parent=Y,this.options=G}get _$isConnected(){return this._$parent._$isConnected}_$setValue(Q){V&&V({kind:"commit to element binding",element:this.element,value:Q,options:this.options}),e(this,Q)}}var dQ=T.litHtmlPolyfillSupportDevMode;dQ?.(D4,L4);(T.litHtmlVersions??=[]).push("3.3.3");if(T.litHtmlVersions.length>1)queueMicrotask(()=>{j4("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var U4=(Q,Y,G)=>{if(Y==null)throw TypeError(`The container to render into may not be ${Y}`);let X=SQ++,K=G?.renderBefore??Y,B=K._$litPart$;if(V&&V({kind:"begin render",id:X,value:Q,container:Y,options:G,part:B}),B===void 0){let J=G?.renderBefore??null;K._$litPart$=B=new L4(Y.insertBefore($4(),J),J,void 0,G??{})}return B._$setValue(Q),V&&V({kind:"end render",id:X,value:Q,container:Y,options:G,part:B}),B};U4.setSanitizer=CQ,U4.createSanitizer=e4,U4._testOnlyClearSanitizerFactoryDoNotCallOrElse=kQ;var nQ=(Q,Y)=>Q,K3=!0,y=globalThis,r3;if(K3)y.litIssuedWarnings??=new Set,r3=(Q,Y)=>{if(Y+=` See https://lit.dev/msg/${Q} for more information.`,!y.litIssuedWarnings.has(Y)&&!y.litIssuedWarnings.has(Q))console.warn(Y),y.litIssuedWarnings.add(Y)};class $ extends w{constructor(){super(...arguments);this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){let Q=super.createRenderRoot();return this.renderOptions.renderBefore??=Q.firstChild,Q}update(Q){let Y=this.render();if(!this.hasUpdated)this.renderOptions.isConnected=this.isConnected;super.update(Q),this.__childPart=U4(Y,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.__childPart?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.__childPart?.setConnected(!1)}render(){return n}}$._$litElement$=!0;$[nQ("finalized",$)]=!0;y.litElementHydrateSupport?.({LitElement:$});var iQ=K3?y.litElementPolyfillSupportDevMode:y.litElementPolyfillSupport;iQ?.({LitElement:$});(y.litElementVersions??=[]).push("4.2.2");if(K3&&y.litElementVersions.length>1)queueMicrotask(()=>{r3("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var d3=null;function q3(Q){d3=Q}async function sQ(Q,Y){let G=(await Q.text()).trim();if(G){try{let X=JSON.parse(G);if(typeof X?.error==="string"&&X.error)return X.error}catch{}return G}return`${Y}: ${Q.status}`}async function I4(Q,Y){if(Q.ok)return;if(Q.status===401)d3?.();throw Error(await sQ(Q,Y))}async function v(Q){let Y=await fetch(Q,{credentials:"same-origin"});return await I4(Y,Q),await Y.json()}async function C4(Q,Y){let G=await fetch(Q,{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify(Y)});await I4(G,Q)}async function b(Q,Y){let G=await fetch(Q,{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify(Y)});return await I4(G,Q),await G.json()}async function p3(Q,Y){let G=await fetch(Q,{method:"PUT",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify(Y)});return await I4(G,Q),await G.json()}function Q4(Q){if(!Q||!Q.op)return!1;return Q.stage!==""&&Q.stage!=="done"&&Q.stage!=="aborted"&&Q.stage!=="error"}async function l3(Q,Y){let G=await fetch(Q,{method:"DELETE",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify(Y)});return await I4(G,Q),await G.json()}var A={authStatus:()=>v("/api/auth/status"),setup:(Q)=>b("/api/auth/setup",{password:Q}),login:(Q)=>C4("/api/auth/login",{password:Q}),logout:()=>C4("/api/auth/logout",{}),recover:(Q,Y)=>b("/api/auth/recover",{recovery_code:Q,password:Y}),changePassword:(Q,Y)=>C4("/api/auth/change-password",{current_password:Q,new_password:Y}),regenerateRecovery:()=>b("/api/auth/recovery",{}),fleet:()=>v("/api/fleet"),system:()=>v("/api/system"),history:()=>v("/api/history"),events:(Q={})=>{let Y=new URLSearchParams;if(Q.since_ms)Y.set("since_ms",String(Q.since_ms));if(Q.kind)Y.set("kind",Q.kind);if(Q.severity)Y.set("severity",Q.severity);if(Q.inverter_uid)Y.set("inverter_uid",Q.inverter_uid);if(Q.limit)Y.set("limit",String(Q.limit));let G=Y.toString();return v("/api/events"+(G?`?${G}`:""))},getSettings:async()=>{let Q=await v("/api/settings");if(Q.error)return{error:Q.error};return{settings:{ecu_id:Q.ecu_id,mac:Q.mac,pan_override:Q.pan_override,zigbee_type:Q.zigbee_type,channel:Q.channel,inverter_names:Q.inverter_names??{}}}},saveSettings:(Q)=>p3("/api/settings",Q),verifyPassword:async(Q)=>{let Y=await fetch("/api/auth/verify",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:Q})});if(Y.status===200)return!0;if(Y.status===401)return!1;let G=await Y.text();throw Error(G.trim()||`/api/auth/verify: ${Y.status}`)},setPower:(Q)=>b("/api/power",Q),setInverterPhase:(Q,Y)=>C4("/api/inverters/phase",{uid:Q,leg:Y}),profiles:()=>v("/api/profiles"),overlays:()=>v("/api/overlays"),selectBase:(Q)=>b("/api/profiles/base",{id:Q}),saveOverlay:(Q)=>p3("/api/profiles/overlay",Q),deleteOverlay:(Q,Y)=>l3("/api/profiles/overlay",{id:Q,uids:Y}),pairingScan:(Q={})=>b("/api/pairing/scan",Q),pairingAdd:(Q)=>b("/api/pairing/add",{serial:Q}),pairingReplace:(Q,Y)=>b("/api/pairing/replace",{old_uid:Q,new_serial:Y}),pairingRekey:(Q,Y=0)=>b("/api/pairing/rekey",{new_pan:Q,channel:Y}),pairingChangeChannel:(Q)=>b("/api/pairing/change-channel",{channel:Q}),pairingRemove:(Q,Y)=>b("/api/inverters/remove",{serial:Q,force:Y}),pairingAbort:()=>b("/api/pairing/abort",{}),pairingStatus:()=>v("/api/pairing/status"),sshKeys:()=>v("/api/access/ssh-keys"),addSshKey:(Q,Y)=>b("/api/access/ssh-keys",{pubkey:Q,comment:Y}),removeSshKey:(Q)=>l3("/api/access/ssh-keys",{fingerprint:Q})};function n3(Q,Y){let G=new EventSource("/api/stream");return G.addEventListener("fleet",(X)=>{try{Q(JSON.parse(X.data))}catch{}}),G.onerror=()=>Y?.(),()=>G.close()}class i3 extends ${static properties={configured:{type:Boolean},error:{state:!0},busy:{state:!0},recoverMode:{state:!0},savedCode:{state:!0},copied:{state:!0}};constructor(){super();this.configured=!0,this.error="",this.busy=!1,this.recoverMode=!1,this.savedCode="",this.copied=!1}static styles=L`
    :host {
      display: grid;
      place-items: center;
      min-height: 100vh;
  ...
  `;firstUpdated(){this.focusFirst()}updated(Q){if(Q.has("recoverMode")||Q.has("savedCode"))this.focusFirst()}focusFirst(){this.renderRoot.querySelector("input")?.focus()}val(Q){return this.renderRoot.querySelector(`#${Q}`)?.value??""}async submit(Q){if(Q.preventDefault(),this.busy)return;this.error="";let Y=!this.configured,G=this.configured&&this.recoverMode;if(Y||G){if(this.val("pw")!==this.val("pw2")){this.error="Passwords do not match.";return}}this.busy=!0;try{if(Y){let X=await A.setup(this.val("pw"));this.savedCode=X.recovery_code}else if(G){let X=await A.recover(this.val("code"),this.val("pw"));this.savedCode=X.recovery_code}else await A.login(this.val("pw")),this.done()}catch(X){this.error=X.message||"failed"}finally{this.busy=!1}}done(){this.dispatchEvent(new CustomEvent("authed",{bubbles:!0,composed:!0}))}async copyCode(){try{await navigator.clipboard?.writeText(this.savedCode),this.copied=!0}catch{}}render(){if(this.savedCode)return this.renderSaved();let Q=!this.configured,Y=this.configured&&this.recoverMode,G=Y?"Reset password":"ECU Console",X=Q?"First run — choose an operator password (min 8 characters).":Y?"Enter your recovery code and a new password.":"Enter the operator password.";return q`
    ...
    `}}customElements.define("login-view",i3);function Z(Q){if(!Number.isFinite(Q))return"";return String(Number(Q.toFixed(3)))}function M(Q){if(!Number.isFinite(Q))return"—";if(Math.abs(Q)>=1000)return`${(Q/1000).toFixed(2)} kW`;return`${Math.round(Q)} W`}function V4(Q){if(!Number.isFinite(Q))return"—";let Y=Math.abs(Q);if(Y>=1e6)return`${(Q/1e6).toFixed(2)} MWh`;if(Y>=1000)return`${(Q/1000).toFixed(2)} kWh`;return`${Math.round(Q)} Wh`}function Y4(Q){return Number.isFinite(Q)?`${Q.toFixed(0)}%`:"—"}function N4(Q){return Q>0?`${Q.toFixed(1)} V`:"—"}function k4(Q){return Q>0?`${Q.toFixed(2)} Hz`:"—"}function s3(Q){return Number.isFinite(Q)?`${Q.toFixed(2)} A`:"—"}function x4(Q){if(!(Q>0))return"idle";if(Q<40)return"low";if(Q<85)return"mid";return"high"}function t3(Q){if(!Number.isFinite(Q)||Q<0)return"—";if(Q<60)return`${Math.round(Q)}s ago`;if(Q<3600)return`${Math.round(Q/60)}m ago`;return`${Math.round(Q/3600)}h ago`}function B3(Q){return Q.replace(/_/g," ").replace(/\b\w/g,(Y)=>Y.toUpperCase())}function g4(Q){if(!Q)return[];return Object.keys(Q).filter((Y)=>Q[Y]).map(B3)}function G4(Q){if(!Q)return"—";return new Date(Q).toLocaleString(void 0,{hour12:!1})}function a3(Q){let Y=(Q||"").toLowerCase();if(Y==="error"||Y==="critical"||Y==="crit"||Y==="fault")return"err";if(Y==="warn"||Y==="warning")return"warn";return"info"}function h(Q){return Q.nameplate_w||0}function X4(Q){return Math.round(h(Q)*20/500)}function K4(Q){let Y=Q.protection?.DA;if(Y==null)return;return Math.round(Y/500*h(Q))}class e3 extends ${static properties={power:{type:Number},cap:{type:Number}};constructor(){super();this.power=0,this.cap=0}static styles=L`
  ...
  `;pct(){if(!(this.cap>0))return 0;return Math.max(0,Math.min(100,this.power/this.cap*100))}render(){let Q=this.pct(),Y=x4(Q),G=90,X=Math.PI*90,K=X*(1-Q/100);return q`
      <div class="wrap">
        ...
        <div class="center">
          ...
          <div class="sub">${Y4(Q)} of ${M(this.cap)}</div>
        </div>
      </div>
  ...
  `;capFromEvent(Q){let Y=this.renderRoot.querySelector(".bar"),G=h(this.inverter);if(!Y)return this.pendingCap??G;let X=Y.getBoundingClientRect(),K=Math.max(0,Math.min(1,(Q.clientX-X.left)/X.width));return Math.min(G,Math.max(X4(this.inverter),Math.round(K*G)))}onDown=(Q)=>{if(!this.inverter?.online||this.busy)return;Q.preventDefault(),this.dragging=!0;try{Q.currentTarget.setPointerCapture?.(Q.pointerId)}catch{}this.pendingCap=this.capFromEvent(Q)};onMove=(Q)=>{if(this.dragging)this.pendingCap=this.capFromEvent(Q)};onUp=(Q)=>{if(!this.dragging)return;this.dragging=!1;try{Q.currentTarget.releasePointerCapture?.(Q.pointerId)}catch{}this.commitCap()};async commitCap(){let Q=this.pendingCap;if(Q==null)return;this.busy=!0,this.error="";try{let G=(await A.setPower({uid:this.inverter.uid,watts:Q})).results?.[0];if(G&&!G.ok)this.error=G.error||"failed";else if(G)this.pendingCap=G.applied_watts}catch(Y){this.error=Y.message||"failed"}finally{this.busy=!1}}render(){let Q=this.inverter;if(!Q)return z;let Y=x4(Q.load_pct),G=Math.max(0,Math.min(100,Q.load_pct)),X=h(Q);if(X<=0)return q`<div class="bar"><div class="fill ${Y}" style="width:${G}%"></div></div>`;let K=this.pendingCap??K4(Q)??X,B=Math.max(0,Math.min(100,K/X*100));return q`
      <div class="row">
        <div
    ...
    `}}customElements.define("cap-bar",Y9);class G9 extends ${static properties={inverter:{attribute:!1},name:{type:String},profile:{type:String},legError:{state:!0},legBusy:{state:!0}};constructor(){super();this.name="",this.profile="",this.legError="",this.legBusy=!1}async setLeg(Q){let Y=this.inverter;if(!Y||Y.phase===Q||this.legBusy)return;this.legBusy=!0,this.legError="";try{await A.setInverterPhase(Y.uid,Q),Y.phase=Q,this.dispatchEvent(new CustomEvent("inverter-updated",{bubbles:!0,composed:!0}))}catch(G){this.legError=G instanceof Error?G.message:String(G)}finally{this.legBusy=!1}}static styles=L`
    :host {
      display: block;
      background: var(--surface);
      border: 1px solid var(--border);
  ...
  `;render(){let Q=this.inverter;if(!Q)return z;let Y=g4(Q.faults);return q`
      <div class="head">
        <div>
      ...
      <div class="power">
        ...
        <span class="cap">/ ${M(Q.nameplate_w)} · ${Y4(Q.load_pct)}</span>
      </div>
      <cap-bar .inverter=${Q}></cap-bar>

      <div class="metrics">
        <div class="metric"><div class="k">Grid</div><div class="v">${N4(Q.grid_v)}</div></div>
      ...
      <div class="leg">
        ...
        ${Q.three_phase?q`<span class="three">3-phase · L1·L2·L3</span>`:q`<span class="legbtns">
              ${[1,2,3].map((G)=>q`<button
                  class="legbtn ${Q.phase===G?"sel":""}"
      ...
      ${this.legError?q`<div class="leg-err">${this.legError}</div>`:z}
  ...
  `;idRow(Q,Y){return Y?q`<div class="k">${Q}</div><div class="v">${Y}</div>`:z}clients(){let Q=new Map;for(let Y of this.system?.peers??[]){let G=Q.get(Y.backend)??{backend:Y.backend,version:Y.version,controller:!1,conns:0};if(G.conns++,G.controller=G.controller||Y.controller,Y.version)G.version=Y.version;Q.set(Y.backend,G)}return[...Q.values()].sort((Y,G)=>Y.backend.localeCompare(G.backend))}render(){let Q=this.system,Y=Q?.ecu,G=this.clients(),X=!!(Y&&(Y.ecu_id||Y.hostname));return q`
    ...
    `}}customElements.define("ecu-clients-card",X9);function tQ(Q,Y,G){if(Q.length<2)return{line:"",area:"",max:0};let X=Q[0].t,K=Math.max(1,Q[Q.length-1].t-X),B=Math.max(1,...Q.map((D)=>D.w)),J=(D)=>[(D.t-X)/K*Y,G-D.w/B*G],H="";for(let D=0;D<Q.length;D++){let[I,F]=J(Q[D]);H+=`${D===0?"M":"L"}${I.toFixed(1)} ${F.toFixed(1)} `}let[U]=J(Q[0]),[W]=J(Q[Q.length-1]),j=`${H}L${W.toFixed(1)} ${G} L${U.toFixed(1)} ${G} Z`;return{line:H.trim(),area:j,max:B}}var v4=600,O4=160;class K9 extends ${static properties={points:{attribute:!1},hoverIdx:{state:!0}};constructor(){super();this.points=[],this.hoverIdx=-1}static styles=L`
    :host { display: block; }
  ...
  `;onMove=(Q)=>{let Y=this.points.length;if(Y<2)return;let X=Q.currentTarget.clientWidth||1,K=Math.min(1,Math.max(0,Q.offsetX/X));this.hoverIdx=Math.round(K*(Y-1))};onLeave=()=>{this.hoverIdx=-1};render(){let Q=this.points??[];if(Q.length<2)return q`<div class="empty">Collecting power history…</div>`;let{line:Y,area:G,max:X}=tQ(Q,v4,O4),K=Q[Q.length-1].w,B=this.hoverIdx,J=B>=0&&B<Q.length,H=Q[0].t,U=Math.max(1,Q[Q.length-1].t-H),W=J?(Q[B].t-H)/U*v4:0,j=J?O4-Q[B].w/X*O4:0;return q`
      <div class="wrap">
        <svg
          viewBox="0 0 ${v4} ${O4}"
        ...
        >
          ...
          ${J?S`<line class="cross" x1=${W} y1="0" x2=${W} y2=${O4} /><circle class="cursor" cx=${W} cy=${j} r="3.5" />`:z}
        </svg>
        ${J?q`<div class="tip" style="left:${W/v4*100}%; top:${j}px">
              <span class="w">${M(Q[B].w)}</span>
              <span class="t">· ${G4(Q[B].t)}</span>
            </div>`:z}
      </div>
      <div class="labels">
  ...
  `;render(){let Q=this.fleet;if(!Q)return q`<div class="empty">Waiting for inv-driver…</div>`;let Y=Q.inverters.reduce((B,J)=>B+h(J),0),G=Q.inverters.reduce((B,J)=>B+X4(J),0),X=Q.inverters.reduce((B,J)=>B+(K4(J)??h(J)),0),K=this.arrayPendingCap??X;return q`
      <div class="grid">
        <div class="panel">
          <h2>Array output</h2>
    ...
    .err { color: var(--err); }
  `;commit=async(Q)=>{let Y=Math.round(Number(Q.target.value));if(!Number.isFinite(Y)||Y<=0)return;this.pendingCap=Y,this.busy=!0,this.error="";try{let X=(await A.setPower({uid:this.inverter.uid,watts:Y})).results?.[0];if(X&&!X.ok)this.error=X.error||"failed";else if(X)this.pendingCap=X.applied_watts}catch(G){this.error=G.message||"failed"}finally{this.busy=!1}};render(){let Q=this.inverter;if(!Q)return z;let Y=h(Q);if(Y<=0)return q`<span class="max">—</span>`;let G=this.pendingCap??K4(Q)??Y;return q`
      <div class="row">
        <input
          type="number"
          min=${X4(Q)}
...
Enter the replacement's 12-digit serial, or leave blank to scan for it. The new unit inherits this one's grid profile, power cap and array slot.`);if(Y===null)return;let G=Y.replace(/\D/g,"");if(G!==""&&G.length!==12){this.notice="Replacement serial must be 12 digits (or blank to scan).";return}this.busy=!0,this.notice="";try{let X=await A.pairingReplace(Q,G);if(!X.ok)throw Error(X.error||"replace rejected");this.applyResp(X.status)}catch(X){this.notice=String(X.message||X)}finally{this.busy=!1}};onRekey=()=>{this.notice="",this.privilegedError="",this.privilegedDialog="rekey"};onChangeChannel=()=>{this.notice="",this.privilegedError="",this.privilegedDialog="channel"};onRemove=(Q)=>{this.notice="",this.privilegedError="",this.removeUid=Q,this.privilegedDialog="remove"};onPrivilegedCancel=()=>{if(this.busy)return;this.privilegedDialog="",this.privilegedError="",this.removeUid=""};onPrivilegedConfirm=async(Q)=>{let Y=this.privilegedDialog;if(!Y)return;let{value:G,force:X}=Q.detail;this.busy=!0,this.privilegedError="",this.notice="";try{let K;if(Y==="rekey")K=await A.pairingRekey(G,0);else if(Y==="channel")K=await A.pairingChangeChannel(Number(G));else K=await A.pairingRemove(this.removeUid,X??!1);if(!K.ok){let B=K.error||(Y==="rekey"?"re-key rejected":Y==="channel"?"channel change rejected":"remove rejected");throw Error(B)}this.privilegedDialog="",this.privilegedError="",this.removeUid="",this.applyResp(K.status)}catch(K){this.privilegedError=String(K.message||K)}finally{this.busy=!1}};onAbort=async()=>{this.aborting=!0;try{let Q=await A.pairingAbort();this.status=Q.status??this.status}catch(Q){this.notice=String(Q.message||Q)}finally{this.aborting=!1,this.fetchStatus()}};onCloseDrawer=()=>{if(Q4(this.status))return;this.drawerOpen=!1};static styles=L`
  ...
  `;connectedCallback(){super.connectedCallback(),this.loadRecent(),this.timer=setInterval(()=>void this.loadRecent(),Q8)}disconnectedCallback(){if(super.disconnectedCallback(),this.timer)clearInterval(this.timer),this.timer=null}updated(Q){if(Q.has("fleet"))this.loadRecent()}async loadRecent(){this.recentLoading=!0;try{let Q=await A.events({kind:"fault_raised",since_ms:Date.now()-Y8,limit:G8});this.recent=Q.events??[],this.recentError=Q.error??""}catch(Q){this.recentError=Q.message||"failed to load events"}finally{this.recentLoading=!1}}alarms(){let Q=[];for(let Y of this.fleet?.inverters??[]){for(let G of g4(Y.faults))Q.push({uid:Y.uid,model:Y.model,label:G,severity:"fault"});if(!Y.online)Q.push({uid:Y.uid,model:Y.model,label:"Inverter offline",severity:"warning"})}return Q}renderLive(){let Q=this.alarms();if(Q.length===0)return q`<div class="ok"><div class="big">✓ No active alarms</div><div>All inverters reporting healthy.</div></div>`;return q`${Q.map((Y)=>q`<div class="row ${Y.severity}">
    ...
    .panel { background: var(--surface); border: 1px solid var(--border); border-radius: 10px; overflow: hidden; }
  `;connectedCallback(){super.connectedCallback(),this.load(),this.timer=setInterval(()=>void this.load(),15000)}disconnectedCallback(){if(super.disconnectedCallback(),this.timer)clearInterval(this.timer);this.timer=null}async load(){this.loading=!0;try{let Q=await A.events({limit:200});this.events=Q.events??[],this.error=Q.error??""}catch(Q){this.error=Q.message}finally{this.loading=!1}}render(){return q`
      <div class="bar">
    ...
    `}}customElements.define("events-view",A9);var D9;function O(Q,Y,G){function X(H,U){if(!H._zod)Object.defineProperty(H,"_zod",{value:{def:U,constr:J,traits:new Set},enumerable:!1});if(H._zod.traits.has(Q))return;H._zod.traits.add(Q),Y(H,U);let W=J.prototype,j=Object.keys(W);for(let D=0;D<j.length;D++){let I=j[D];if(!(I in H))H[I]=W[I].bind(H)}}let K=G?.Parent??Object;class B extends K{}Object.defineProperty(B,"name",{value:Q});function J(H){var U;let W=G?.Parent?new B:this;X(W,H),(U=W._zod).deferred??(U.deferred=[]);for(let j of W._zod.deferred)j();return W}return Object.defineProperty(J,"init",{value:X}),Object.defineProperty(J,Symbol.hasInstance,{value:(H)=>{if(G?.Parent&&H instanceof G.Parent)return!0;return H?._zod?.traits?.has(Q)}}),Object.defineProperty(J,"name",{value:Q}),J}var $6=Symbol("zod_brand");class m extends Error{constructor(){super("Encountered Promise during synchronous parse. Use .parseAsync() instead.")}}class z3 extends Error{constructor(Q){super(`Encountered unidirectional transform during encode: ${Q}`);this.name="ZodEncodeError"}}(D9=globalThis).__zod_globalConfig??(D9.__zod_globalConfig={});var J3=globalThis.__zod_globalConfig;function q4(Q){if(Q)Object.assign(J3,Q);return J3}function F9(Q,Y){if(typeof Y==="bigint")return Y.toString();return Y}function I9(Q){return{get value(){{let G=Q();return Object.defineProperty(this,"value",{value:G}),G}throw Error("cached value already set")}}}function V9(Q){return Q===null||Q===void 0}function N9(Q){let Y=Q.startsWith("^")?1:0,G=Q.endsWith("$")?Q.length-1:Q.length;return Q.slice(Y,G)}var L9=Symbol("evaluating");function x(Q,Y,G){let X=void 0;Object.defineProperty(Q,Y,{get(){if(X===L9)return;if(X===void 0)X=L9,X=G();return X},set(K){Object.defineProperty(Q,Y,{value:K})},configurable:!0})}var W3="captureStackTrace"in Error?Error.captureStackTrace:(...Q)=>{};function O9(Q){return typeof Q==="object"&&Q!==null&&!Array.isArray(Q)}function U3(Q,Y,G){let X=new Q._zod.constr(Y??Q._zod.def);if(!Y||G?.parent)X._zod.parent=Q;return X}function u(Q){let Y=Q;if(!Y)return{};if(typeof Y==="string")return{error:()=>Y};if(Y?.message!==void 0){if(Y?.error!==void 0)throw Error("Cannot specify both `message` and `error` params");Y.error=Y.message}if(delete Y.message,typeof Y.error==="string")return{...Y,error:()=>Y.error};return Y}function P9(Q){return Object.keys(Q).filter((Y)=>{return Q[Y]._zod.optin==="optional"&&Q[Y]._zod.optout==="optional"})}var X8={safeint:[Number.MIN_SAFE_INTEGER,Number.MAX_SAFE_INTEGER],int32:[-2147483648,2147483647],uint32:[0,4294967295],float32:[-340282346638528860000000000000000000000,340282346638528860000000000000000000000],float64:[-Number.MAX_VALUE,Number.MAX_VALUE]};function P4(Q,Y=0){if(Q.aborted===!0)return!0;for(let G=Y;G<Q.issues.length;G++)if(Q.issues[G]?.continue!==!0)return!0;return!1}function E9(Q,Y=0){if(Q.aborted===!0)return!0;for(let G=Y;G<Q.issues.length;G++)if(Q.issues[G]?.continue===!1)return!0;return!1}function c4(Q,Y){return Y.map((G)=>{var X;return(X=G).path??(X.path=[]),G.path.unshift(Q),G})}function h4(Q){return typeof Q==="string"?Q:Q?.message}function B4(Q,Y,G){let X=Q.message?Q.message:h4(Q.inst?._zod.def?.error?.(Q))??h4(Y?.error?.(Q))??h4(G.customError?.(Q))??h4(G.localeError?.(Q))??"Invalid input",{inst:K,continue:B,input:J,...H}=Q;if(H.path??(H.path=[]),H.message=X,Y?.reportInput)H.input=J;return H}function M9(Q){if(Array.isArray(Q))return"array";if(typeof Q==="string")return"string";return"unknown"}var Z9=(Q,Y)=>{Q.name="$ZodError",Object.defineProperty(Q,"_zod",{value:Q._zod,enumerable:!1}),Object.defineProperty(Q,"issues",{value:Y,enumerable:!1}),Q.message=JSON.stringify(Y,F9,2),Object.defineProperty(Q,"toString",{value:()=>Q.message,enumerable:!1})},R9=O("$ZodError",Z9),E4=O("$ZodError",Z9,{Parent:Error});var q8=(Q)=>(Y,G,X,K)=>{let B=X?{...X,async:!1}:{async:!1},J=Y._zod.run({value:G,issues:[]},B);if(J instanceof Promise)throw new m;if(J.issues.length){let H=new(K?.Err??Q)(J.issues.map((U)=>B4(U,B,q4())));throw W3(H,K?.callee),H}return J.value},y4=q8(E4),B8=(Q)=>async(Y,G,X,K)=>{let B=X?{...X,async:!0}:{async:!0},J=Y._zod.run({value:G,issues:[]},B);if(J instanceof Promise)J=await J;if(J.issues.length){let H=new(K?.Err??Q)(J.issues.map((U)=>B4(U,B,q4())));throw W3(H,K?.callee),H}return J.value},m4=B8(E4),J8=(Q)=>(Y,G,X)=>{let K=X?{...X,async:!1}:{async:!1},B=Y._zod.run({value:G,issues:[]},K);if(B instanceof Promise)throw new m;return B.issues.length?{success:!1,error:new(Q??R9)(B.issues.map((J)=>B4(J,K,q4())))}:{success:!0,data:B.value}},s=J8(E4),z8=(Q)=>async(Y,G,X)=>{let K=X?{...X,async:!0}:{async:!0},B=Y._zod.run({value:G,issues:[]},K);if(B instanceof Promise)B=await B;return B.issues.length?{success:!1,error:new Q(B.issues.map((J)=>B4(J,K,q4())))}:{success:!0,data:B.value}},M4=z8(E4);var H8="(?:(?:\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\\d|30)|(?:02)-(?:0[1-9]|1\\d|2[0-8])))",W8=new RegExp(`^${H8}$`);var _9=(Q)=>{let Y=Q?`[\\s\\S]{${Q?.minimum??0},${Q?.maximum??""}}`:"[\\s\\S]*";return new RegExp(`^${Y}$`)};var w9=/^-?\d+(?:\.\d+)?$/;var z4=O("$ZodCheck",(Q,Y)=>{var G;Q._zod??(Q._zod={}),Q._zod.def=Y,(G=Q._zod).onattach??(G.onattach=[])});var S9=O("$ZodCheckMinLength",(Q,Y)=>{var G;z4.init(Q,Y),(G=Q._zod.def).when??(G.when=(X)=>{let K=X.value;return!V9(K)&&K.length!==void 0}),Q._zod.onattach.push((X)=>{let K=X._zod.bag.minimum??Number.NEGATIVE_INFINITY;if(Y.minimum>K)X._zod.bag.minimum=Y.minimum}),Q._zod.check=(X)=>{let K=X.value;if(K.length>=Y.minimum)return;let J=M9(K);X.issues.push({origin:J,code:"too_small",minimum:Y.minimum,inclusive:!0,input:K,inst:Q,continue:!Y.abort})}});var j8=O("$ZodCheckStringFormat",(Q,Y)=>{var G,X;if(z4.init(Q,Y),Q._zod.onattach.push((K)=>{let B=K._zod.bag;if(B.format=Y.format,Y.pattern)B.patterns??(B.patterns=new Set),B.patterns.add(Y.pattern)}),Y.pattern)(G=Q._zod).check??(G.check=(K)=>{if(Y.pattern.lastIndex=0,Y.pattern.test(K.value))return;K.issues.push({origin:"string",code:"invalid_format",format:Y.format,input:K.value,...Y.pattern?{pattern:Y.pattern.toString()}:{},inst:Q,continue:!Y.abort})});else(X=Q._zod).check??(X.check=()=>{})}),b9=O("$ZodCheckRegex",(Q,Y)=>{j8.init(Q,Y),Q._zod.check=(G)=>{if(Y.pattern.lastIndex=0,Y.pattern.test(G.value))return;G.issues.push({origin:"string",code:"invalid_format",format:"regex",input:G.value,pattern:Y.pattern.toString(),inst:Q,continue:!Y.abort})}});var C9=O("$ZodCheckOverwrite",(Q,Y)=>{z4.init(Q,Y),Q._zod.check=(G)=>{G.value=Y.tx(G.value)}});var k9={major:4,minor:4,patch:3};var f=O("$ZodType",(Q,Y)=>{var G;Q??(Q={}),Q._zod.def=Y,Q._zod.bag=Q._zod.bag||{},Q._zod.version=k9;let X=[...Q._zod.def.checks??[]];if(Q._zod.traits.has("$ZodCheck"))X.unshift(Q);for(let K of X)for(let B of K._zod.onattach)B(Q);if(X.length===0)(G=Q._zod).deferred??(G.deferred=[]),Q._zod.deferred?.push(()=>{Q._zod.run=Q._zod.parse});else{let K=(J,H,U)=>{let W=P4(J),j;for(let D of H){if(D._zod.def.when){if(E9(J))continue;if(!D._zod.def.when(J))continue}else if(W)continue;let I=J.issues.length,F=D._zod.check(J);if(F instanceof Promise&&U?.async===!1)throw new m;if(j||F instanceof Promise)j=(j??Promise.resolve()).then(async()=>{if(await F,J.issues.length===I)return;if(!W)W=P4(J,I)});else{if(J.issues.length===I)continue;if(!W)W=P4(J,I)}}if(j)return j.then(()=>{return J});return J},B=(J,H,U)=>{if(P4(J))return J.aborted=!0,J;let W=K(H,X,U);if(W instanceof Promise){if(U.async===!1)throw new m;return W.then((j)=>Q._zod.parse(j,U))}return Q._zod.parse(W,U)};Q._zod.run=(J,H)=>{if(H.skipChecks)return Q._zod.parse(J,H);if(H.direction==="backward"){let W=Q._zod.parse({value:J.value,issues:[]},{...H,skipChecks:!0});if(W instanceof Promise)return W.then((j)=>{return B(j,J,H)});return B(W,J,H)}let U=Q._zod.parse(J,H);if(U instanceof Promise){if(H.async===!1)throw new m;return U.then((W)=>K(W,X,H))}return K(U,X,H)}}x(Q,"~standard",()=>({validate:(K)=>{try{let B=s(Q,K);return B.success?{value:B.data}:{issues:B.error?.issues}}catch(B){return M4(Q,K).then((J)=>J.success?{value:J.data}:{issues:J.error?.issues})}},vendor:"zod",version:1}))}),v9=O("$ZodString",(Q,Y)=>{f.init(Q,Y),Q._zod.pattern=[...Q?._zod.bag?.patterns??[]].pop()??_9(Q._zod.bag),Q._zod.parse=(G,X)=>{if(Y.coerce)try{G.value=String(G.value)}catch(K){}if(typeof G.value==="string")return G;return G.issues.push({expected:"string",code:"invalid_type",input:G.value,inst:Q}),G}});var h9=O("$ZodNumber",(Q,Y)=>{f.init(Q,Y),Q._zod.pattern=Q._zod.bag.pattern??w9,Q._zod.parse=(G,X)=>{if(Y.coerce)try{G.value=Number(G.value)}catch(J){}let K=G.value;if(typeof K==="number"&&!Number.isNaN(K)&&Number.isFinite(K))return G;let B=typeof K==="number"?Number.isNaN(K)?"NaN":!Number.isFinite(K)?"Infinity":void 0:void 0;return G.issues.push({expected:"number",code:"invalid_type",input:K,inst:Q,...B?{received:B}:{}}),G}});function x9(Q,Y,G){if(Q.issues.length)Y.issues.push(...c4(G,Q.issues));Y.value[G]=Q.value}var c9=O("$ZodArray",(Q,Y)=>{f.init(Q,Y),Q._zod.parse=(G,X)=>{let K=G.value;if(!Array.isArray(K))return G.issues.push({expected:"array",code:"invalid_type",input:K,inst:Q}),G;G.value=Array(K.length);let B=[];for(let J=0;J<K.length;J++){let H=K[J],U=Y.element._zod.run({value:H,issues:[]},X);if(U instanceof Promise)B.push(U.then((W)=>x9(W,G,J)));else x9(U,G,J)}if(B.length)return Promise.all(B).then(()=>G);return G}});function f4(Q,Y,G,X,K,B){let J=G in X;if(Q.issues.length){if(K&&B&&!J)return;Y.issues.push(...c4(G,Q.issues))}if(!J&&!K){if(!Q.issues.length)Y.issues.push({code:"invalid_type",expected:"nonoptional",input:void 0,path:[G]});return}if(Q.value===void 0){if(J)Y.value[G]=void 0}else Y.value[G]=Q.value}function D8(Q){let Y=Object.keys(Q.shape);for(let X of Y)if(!Q.shape?.[X]?._zod?.traits?.has("$ZodType"))throw Error(`Invalid element at key "${X}": expected a Zod schema`);let G=P9(Q.shape);return{...Q,keys:Y,keySet:new Set(Y),numKeys:Y.length,optionalKeys:new Set(G)}}function L8(Q,Y,G,X,K,B){let J=[],H=K.keySet,U=K.catchall._zod,W=U.def.type,j=U.optin==="optional",D=U.optout==="optional";for(let I in Y){if(I==="__proto__")continue;if(H.has(I))continue;if(W==="never"){J.push(I);continue}let F=U.run({value:Y[I],issues:[]},X);if(F instanceof Promise)Q.push(F.then((P)=>f4(P,G,I,Y,j,D)));else f4(F,G,I,Y,j,D)}if(J.length)G.issues.push({code:"unrecognized_keys",keys:J,input:Y,inst:B});if(!Q.length)return G;return Promise.all(Q).then(()=>{return G})}var y9=O("$ZodObject",(Q,Y)=>{if(f.init(Q,Y),!Object.getOwnPropertyDescriptor(Y,"shape")?.get){let H=Y.shape;Object.defineProperty(Y,"shape",{get:()=>{let U={...H};return Object.defineProperty(Y,"shape",{value:U}),U}})}let X=I9(()=>D8(Y));x(Q._zod,"propValues",()=>{let H=Y.shape,U={};for(let W in H){let j=H[W]._zod;if(j.values){U[W]??(U[W]=new Set);for(let D of j.values)U[W].add(D)}}return U});let K=O9,B=Y.catchall,J;Q._zod.parse=(H,U)=>{J??(J=X.value);let W=H.value;if(!K(W))return H.issues.push({expected:"object",code:"invalid_type",input:W,inst:Q}),H;H.value={};let j=[],D=J.shape;for(let I of J.keys){let F=D[I],P=F._zod.optin==="optional",N=F._zod.optout==="optional",g=F._zod.run({value:W[I],issues:[]},U);if(g instanceof Promise)j.push(g.then((p)=>f4(p,H,I,W,P,N)));else f4(g,H,I,W,P,N)}if(!B)return j.length?Promise.all(j).then(()=>H):H;return L8(j,W,H,U,X.value,Q)}});var m9=O("$ZodTransform",(Q,Y)=>{f.init(Q,Y),Q._zod.optin="optional",Q._zod.parse=(G,X)=>{if(X.direction==="backward")throw new z3(Q.constructor.name);let K=Y.transform(G.value,G);if(X.async)return(K instanceof Promise?K:Promise.resolve(K)).then((J)=>{return G.value=J,G.fallback=!0,G});if(K instanceof Promise)throw new m;return G.value=K,G.fallback=!0,G}});function g9(Q,Y){if(Y===void 0&&(Q.issues.length||Q.fallback))return{issues:[],value:void 0};return Q}var u9=O("$ZodOptional",(Q,Y)=>{f.init(Q,Y),Q._zod.optin="optional",Q._zod.optout="optional",x(Q._zod,"values",()=>{return Y.innerType._zod.values?new Set([...Y.innerType._zod.values,void 0]):void 0}),x(Q._zod,"pattern",()=>{let G=Y.innerType._zod.pattern;return G?new RegExp(`^(${N9(G.source)})?$`):void 0}),Q._zod.parse=(G,X)=>{if(Y.innerType._zod.optin==="optional"){let K=G.value,B=Y.innerType._zod.run(G,X);if(B instanceof Promise)return B.then((J)=>g9(J,K));return g9(B,K)}if(G.value===void 0)return G;return Y.innerType._zod.run(G,X)}});var f9=O("$ZodPipe",(Q,Y)=>{f.init(Q,Y),x(Q._zod,"values",()=>Y.in._zod.values),x(Q._zod,"optin",()=>Y.in._zod.optin),x(Q._zod,"optout",()=>Y.out._zod.optout),x(Q._zod,"propValues",()=>Y.in._zod.propValues),Q._zod.parse=(G,X)=>{if(X.direction==="backward"){let B=Y.out._zod.run(G,X);if(B instanceof Promise)return B.then((J)=>u4(J,Y.in,X));return u4(B,Y.in,X)}let K=Y.in._zod.run(G,X);if(K instanceof Promise)return K.then((B)=>u4(B,Y.out,X));return u4(K,Y.out,X)}});function u4(Q,Y,G){if(Q.issues.length)return Q.aborted=!0,Q;return Y._zod.run({value:Q.value,issues:Q.issues,fallback:Q.fallback},G)}function o9(Q,Y){return new Q({type:"string",...u(Y)})}function r9(Q,Y){return new Q({type:"number",checks:[],...u(Y)})}function Z4(Q,Y){return new S9({check:"min_length",...u(Y),minimum:Q})}function o4(Q,Y){return new b9({check:"string_format",format:"regex",...u(Y),pattern:Q})}function p9(Q){return new C9({check:"overwrite",tx:Q})}function j3(){return p9((Q)=>Q.trim())}var t=O("ZodMiniType",(Q,Y)=>{if(!Q._zod)throw Error("Uninitialized schema in ZodMiniType.");f.init(Q,Y),Q.def=Y,Q.type=Y.type,Q.parse=(G,X)=>y4(Q,G,X,{callee:Q.parse}),Q.safeParse=(G,X)=>s(Q,G,X),Q.parseAsync=async(G,X)=>m4(Q,G,X,{callee:Q.parseAsync}),Q.safeParseAsync=async(G,X)=>M4(Q,G,X),Q.check=(...G)=>{return Q.clone({...Y,checks:[...Y.checks??[],...G.map((X)=>typeof X==="function"?{_zod:{check:X,def:{check:"custom"},onattach:[]}}:X)]},{parent:!0})},Q.with=Q.check,Q.clone=(G,X)=>U3(Q,G,X),Q.brand=()=>Q,Q.register=(G,X)=>{return G.add(Q,X),Q},Q.apply=(G)=>G(Q)}),V8=O("ZodMiniString",(Q,Y)=>{v9.init(Q,Y),t.init(Q,Y)});function H4(Q){return o9(V8,Q)}var N8=O("ZodMiniNumber",(Q,Y)=>{h9.init(Q,Y),t.init(Q,Y)});function l9(Q){return r9(N8,Q)}var O8=O("ZodMiniArray",(Q,Y)=>{c9.init(Q,Y),t.init(Q,Y)});function $3(Q,Y){return new O8({type:"array",element:Q,...u(Y)})}var P8=O("ZodMiniObject",(Q,Y)=>{y9.init(Q,Y),t.init(Q,Y),x(Q,"shape",()=>Y.shape)});function A3(Q,Y){let G={type:"object",shape:Q??{},...u(Y)};return new P8(G)}var E8=O("ZodMiniTransform",(Q,Y)=>{m9.init(Q,Y),t.init(Q,Y)});function d9(Q){return new E8({type:"transform",transform:Q})}var M8=O("ZodMiniOptional",(Q,Y)=>{u9.init(Q,Y),t.init(Q,Y)});function D3(Q){return new M8({type:"optional",innerType:Q})}var Z8=O("ZodMiniPipe",(Q,Y)=>{f9.init(Q,Y),t.init(Q,Y)});function n9(Q,Y){return new Z8({type:"pipe",in:Q,out:Y})}function i9(Q,Y){let G=new z4({check:"custom",...u(Y)});return G._zod.check=Q,G}var s9="invdriver.gridprofile/v1",w8=H4().check(o4(/^[A-Z]{2}$/,"must match ^[A-Z]{2}$")),T8=H4().check(o4(/^[0-9A-Fa-f]{12}$/,"must be 12 hex characters")),S8=n9(d9((Q)=>{if(Q&&typeof Q==="object"){let Y=Q,G="aps_code"in Y||"value"in Y,X="apply"in Y||"native"in Y;if(G)return{aps_code:Y.aps_code,value:Y.value,unit:Y.unit};if(X){let K=Y.apply??{},B=Y.native??{};return{aps_code:K.aps_code,value:B.value,unit:B.unit}}}return Q}),A3({aps_code:w8,value:l9(),unit:D3(H4())})),b8=A3({schema:D3(H4()),id:H4().check(j3(),Z4(1,"must be a non-empty string")),uids:$3(T8).check(Z4(1,"must contain at least one inverter UID")),points:$3(S8).check(Z4(1,"must contain at least one parameter override"))}),C8=b8.check(i9((Q)=>{let Y=Q.value,G=new Map;for(let K=0;K<Y.points.length;K++){let B=Y.points[K].aps_code,J=G.get(B);if(J!==void 0)Q.issues.push({code:"custom",path:["points",K,"aps_code"],message:`duplicate aps_code "${B}" (also at points[${J}])`,input:Y});else G.set(B,K)}let X=new Map;for(let K=0;K<Y.uids.length;K++){let B=Y.uids[K].toLowerCase(),J=X.get(B);if(J!==void 0)Q.issues.push({code:"custom",path:["uids",K],message:`duplicate uid "${Y.uids[K]}" (also at uids[${J}])`,input:Y});else X.set(B,K)}}));function k8(Q){let Y="";for(let G of Q)if(typeof G==="number")Y+=`[${G}]`;else Y+=Y?`.${String(G)}`:String(G);return Y||"(root)"}function t9(Q){let Y=s(C8,Q);if(!Y.success)return{ok:!1,errors:Y.error.issues.map((J)=>`${k8(J.path)}: ${J.message}`)};let G=[];if(Y.data.schema!==void 0&&Y.data.schema!==s9)G.push(`schema tag "${Y.data.schema}" does not match expected "${s9}"`);let X=Y.data.points.map((B)=>{let J={aps_code:B.aps_code,value:B.value};if(B.unit!==void 0&&B.unit!=="")J.unit=B.unit;return J});return{ok:!0,profile:{id:Y.data.id.trim(),uids:Y.data.uids,points:X},warnings:G}}class a9 extends ${static properties={profiles:{attribute:!1},activeBase:{attribute:!1},reconcilerReady:{attribute:!1},busy:{attribute:!1},selected:{state:!0}};constructor(){super();this.profiles=[],this.activeBase="",this.reconcilerReady=!0,this.busy=!1,this.selected=""}static styles=L`
    :host { display: block; }
  ...
  `;render(){let Q=this.deadband,Y=this.slope,G=this.trip,X=this.nominal;if(Q===void 0||Y===void 0||Y<=0)return q`<div class="empty">Set the curtailment start frequency and slope to preview the curve.</div>`;let K=Q+100/Y,B=X-0.3,J=Math.max(G??0,K,Q+1.5,X+1.5)+0.2,H=480,U=170,W=36,j=12,D=10,I=24,F=(E)=>W+(E-B)/(J-B)*(H-W-j),P=(E)=>D+(100-E)/100*(U-D-I),N=Math.min(K,J),g=Math.max(0,100-Y*(N-Q)),p=[[B,100],[Q,100],[N,g],...K<J?[[J,0]]:[]].map(([E,VQ])=>`${F(E).toFixed(1)},${P(VQ).toFixed(1)}`).join(" "),o=[];for(let E=Math.ceil(B*2)/2;E<=J;E+=0.5)o.push(E);return q`
      <svg viewBox="0 0 ${H} ${U}" role="img" aria-label="Frequency-Watt curtailment curve">
        ...
        ${o.map((E)=>S`<text x=${F(E)} y=${U-I+12} text-anchor="middle">${E.toFixed(1)}</text>`)}
        <line class="frame" x1=${W} y1=${D} x2=${W} y2=${U-I} />
        <line class="frame" x1=${W} y1=${U-I} x2=${H-j} y2=${U-I} />
        <line class="dead" x1=${F(Q)} y1=${D} x2=${F(Q)} y2=${U-I} />
        <text class="lbl" x=${F(Q)} y=${D+8} text-anchor="middle">start ${Z(Q)} Hz</text>
        ${K<=J?S`<line class="dead" x1=${F(K)} y1=${D} x2=${F(K)} y2=${U-I} />
              <text class="lbl" x=${F(K)} y=${D+8} text-anchor="middle">0% at ${Z(K)} Hz</text>`:z}
        ${G!==void 0&&G>=B&&G<=J?S`<line class="trip" x1=${F(G)} y1=${D} x2=${F(G)} y2=${U-I} />
              <text x=${F(G)} y=${U-I-4} text-anchor="middle" fill="var(--err)">trip ${Z(G)} Hz</text>`:z}
        <polyline class="curve" points=${p} />
  ...
  `;render(){let Q=(this.markers??[]).filter((N)=>Number.isFinite(N.value));if(!Q.length)return q`<div class="empty">No thresholds set.</div>`;let Y=Q.map((N)=>N.value).concat(this.nominal!==void 0?[this.nominal]:[]),G=Math.min(...Y),X=Math.max(...Y),K=(X-G)*0.14||1;G-=K,X+=K;let B=480,J=70,H=10,U=10,W=34,j=(N)=>H+(N-G)/(X-G)*(B-H-U),D=Q.filter((N)=>N.kind==="under").map((N)=>N.value),I=Q.filter((N)=>N.kind==="over").map((N)=>N.value),F=D.length?Math.max(...D):G,P=I.length?Math.min(...I):X;return q`
      <svg viewBox="0 0 ${B} ${J}" role="img" aria-label="Trip thresholds">
        ...
        ${Q.map((N,g)=>{let p=N.kind,E=g%2===0?W-12:W+22;return S`<line class=${p} x1=${j(N.value)} y1=${W-7} x2=${j(N.value)} y2=${W+7} />
  ...
  `;currentDetail(){let Q=this.shadowRoot,Y=(G)=>(Q?.querySelector(`#${G}`)?.value??"").trim();return{ecu_id:Y("ecu_id"),mac:Y("mac"),pan_override:Y("pan_override"),zigbee_type:Y("zigbee_type"),channel:g8(Y("channel"))}}computeEffectivePAN(Q){let Y=HQ(Q.pan_override);if(Y)return Y;return WQ(Q.mac||"")}effectivePAN(){return this.computeEffectivePAN(this.settings)}effectiveChannel(){let Q=this.settings.channel;return Q&&Q>0?Q:zQ}sensitiveChange(Q){return Q.mac!==(this.settings.mac??"")||Q.pan_override!==(this.settings.pan_override??"")}macInputInvalid(Q){if(Q.mac===(this.settings.mac??""))return!1;return Q.mac!==""&&!I3(Q.mac)}save=()=>{if(jQ(this.typedChannel))return;let Q=this.currentDetail(),Y=this.sensitiveChange(Q);if(Y&&this.macInputInvalid(Q))return;let G=this.effectivePAN(),X=this.computeEffectivePAN(Q);if(Y&&!X)return;if(G&&X&&X!==G){this.pendingDetail=Q,this.pwdError="",this.confirming=!0,queueMicrotask(()=>{this.shadowRoot?.querySelector("#confirm_pwd")?.focus()});return}this.dispatchSave(Q)};dispatchSave(Q){this.dispatchEvent(new CustomEvent("save",{detail:Q,bubbles:!0,composed:!0}))}confirmCancel=()=>{this.confirming=!1,this.pendingDetail=null,this.pwdError="",this.pwdBusy=!1};confirmSubmit=async()=>{if(this.pwdBusy)return;let Y=this.shadowRoot?.querySelector("#confirm_pwd")?.value??"";if(!Y){this.pwdError="Password required.";return}this.pwdBusy=!0,this.pwdError="";try{if(!await A.verifyPassword(Y)){this.pwdError="Wrong password.";return}let X=this.pendingDetail;if(this.confirming=!1,this.pendingDetail=null,X)this.dispatchSave(X)}catch(G){this.pwdError=G.message||"Verification failed."}finally{this.pwdBusy=!1}};onPwdKey=(Q)=>{if(Q.key==="Enter")Q.preventDefault(),this.confirmSubmit()};render(){let Q=this.settings,Y="e.g. the serial on the device label",G=Q.ecu_id??"",X=this.hostname||"",K=this.effectivePAN(),B=this.effectiveChannel(),J=Q.mac?`effective PAN source: ${Q.mac}`:"",H=Q.pan_override?K?`effective: ${K}`:"":K?`effective: ${K} (from MAC)`:"",U=Q.zigbee_type?"":"effective: apsystems (default)",W=`effective: ${B}`,j=this.typedMac!==(Q.mac??""),D=this.typedPan!==(Q.pan_override??""),I=j||D,F=j&&this.typedMac!==""&&!I3(this.typedMac),P=!!HQ(this.typedPan)||!!WQ(this.typedMac),N=I&&!P,g=jQ(this.typedChannel),p=g||I&&(F||N),o="";if(F)o="MAC must be 6 colon-separated hex octets (e.g. aa:bb:cc:dd:ee:ff).";else if(I&&N)o="Cannot resolve effective PAN; refusing to save MAC / PAN-override changes.";return q`
      <div class="grid">
        <label>
          ...
          />
          <div class="hint">
            effective: ${Q.ecu_id||"(none — blank in Modbus)"}${X?q` · suggestion: ${X}`:z}
          </div>
        </label>
        <label>
          MAC
        ...
        <label>
          ...
          ${g?q`<div class="err-inline">Channel must be empty (auto) or an integer 11–26.</div>`:z}
        </label>
        <label>
          ZigBee type
        ...
        ${o?q`<div class="banner err">${o}</div>`:z}
        <div class="actions">
  ...
  `;val(Q){return this.renderRoot.querySelector(`#${Q}`)?.value??""}clear(Q){let Y=this.renderRoot.querySelector(`#${Q}`);if(Y)Y.value=""}changePassword=async(Q)=>{if(Q.preventDefault(),this.pwBusy)return;if(this.pwError="",this.pwNotice="",this.val("new")!==this.val("new2")){this.pwError="New passwords do not match.";return}this.pwBusy=!0;try{await A.changePassword(this.val("cur"),this.val("new")),this.pwNotice="Password changed.",this.clear("cur"),this.clear("new"),this.clear("new2")}catch(Y){this.pwError=Y.message||"failed"}finally{this.pwBusy=!1}};regenerate=async()=>{if(this.recBusy)return;this.recError="",this.newCode="",this.recBusy=!0;try{let Q=await A.regenerateRecovery();this.newCode=Q.recovery_code}catch(Q){this.recError=Q.message||"failed"}finally{this.recBusy=!1}};render(){return q`
      <div class="section">
    ...
    .banner.err { color: var(--err); border: 1px solid var(--err); background: color-mix(in srgb, var(--err) 12%, transparent); }
    .loading { color: var(--muted); font-size: 13px; }
  `;connectedCallback(){super.connectedCallback(),this.load(),this.loadHostname()}async load(){this.loading=!0;try{let Q=await A.getSettings();this.settings=Q.settings??null,this.error=Q.error??""}catch(Q){this.error=Q.message}finally{this.loading=!1}}async loadHostname(){try{let Q=await A.system();this.hostname=Q?.ecu?.hostname??""}catch{this.hostname=""}}onSave=async(Q)=>{this.saving=!0,this.notice="",this.error="";try{this.settings=await A.saveSettings(Q.detail),this.notice="Settings saved."}catch(Y){this.error=Y.message}finally{this.saving=!1,await this.load()}};render(){return q`
      <div class="panel">
        <h2>ECU settings</h2>
        ${this.notice?q`<div class="banner ok">${this.notice}</div>`:z}
        ${this.error?q`<div class="banner err">⚠ ${this.error}</div>`:z}
  ...
  `;onVisible=()=>{if(document.visibilityState==="visible")this.load()};connectedCallback(){super.connectedCallback(),this.load(),document.addEventListener("visibilitychange",this.onVisible)}disconnectedCallback(){document.removeEventListener("visibilitychange",this.onVisible),super.disconnectedCallback()}async load(){this.loading=!0;try{this.state=await A.sshKeys(),this.error=this.state.error??""}catch(Q){this.error=Q.message}finally{this.loading=!1}}val(Q){return this.renderRoot.querySelector(`#${Q}`)?.value??""}clear(Q){let Y=this.renderRoot.querySelector(`#${Q}`);if(Y)Y.value=""}addKey=async(Q)=>{if(Q.preventDefault(),this.adding)return;this.addError="",this.notice="";let Y=this.val("pubkey").trim();if(!Y){this.addError="Paste a public key.";return}this.adding=!0;try{this.state=await A.addSshKey(Y,this.val("comment").trim()),this.error=this.state.error??"",this.notice="Key added.",this.clear("pubkey"),this.clear("comment")}catch(G){this.addError=G.message||"failed"}finally{this.adding=!1}};askDelete(Q){this.pendingFp=Q,this.pwError="",queueMicrotask(()=>{this.renderRoot.querySelector("#delpw")?.focus()})}cancelDelete=()=>{if(this.deleting)return;this.pendingFp="",this.pwError=""};confirmDelete=async()=>{if(this.deleting)return;let Q=this.val("delpw");if(!Q){this.pwError="Password required.";return}this.deleting=!0,this.pwError="",this.notice="";try{if(!await A.verifyPassword(Q)){this.pwError="Password is wrong.";return}this.state=await A.removeSshKey(this.pendingFp),this.error=this.state.error??"",this.notice="Key removed.",this.pendingFp=""}catch(Y){this.pwError=Y.message||"failed"}finally{this.deleting=!1}};onDialogKey=(Q)=>{if(Q.key==="Enter")Q.preventDefault(),this.confirmDelete();else if(Q.key==="Escape")Q.preventDefault(),this.cancelDelete()};renderKey(Q){return q`
      <li class="key">
        <div class="keymeta">
          ${Q.comment?q`<div class="comment">${Q.comment}</div>`:q`<div class="comment none">(no comment)</div>`}
          <div class="fp">${Q.fingerprint}</div>
          <div class="added">Added ${G4(Q.added_ms)}</div>
        </div>
        <button
          class="danger"
          type="button"
  ...
  `;connectedCallback(){super.connectedCallback(),window.addEventListener("hashchange",this.onHash),q3(this.onUnauthorized),this.onHash(),this.init()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hashchange",this.onHash),q3(null),this.stopStreams()}onUnauthorized=()=>{if(!this.authed)return;this.authed=!1,this.stopStreams(),this.fleet=null,this.system=null};onHash=()=>{let Q=(location.hash.replace(/^#\/?/,"")||"dashboard").split("/")[0];if(this.route=V3.some((Y)=>Y.id===Q)?Q:"dashboard",this.navOpen=!1,this.route==="dashboard"&&this.authed)this.fetchOverlays()};async init(){try{let Q=await A.authStatus();if(this.configured=Q.configured,this.authed=Q.authenticated,this.authed)this.startStreams()}catch{}finally{this.ready=!0}}onAuthed=async()=>{this.authed=!0,this.configured=!0,this.startStreams()};logout=async()=>{try{await A.logout()}catch{}this.authed=!1,this.stopStreams(),this.fleet=null,this.system=null};startStreams(){this.stopStreams(),this.closeSSE=n3((Y)=>{this.fleet=Y});let Q=()=>A.system().then((Y)=>this.system=Y).catch(()=>{});Q(),this.sysTimer=setInterval(Q,5000),this.fetchSettings(),this.fetchOverlays()}async fetchSettings(){try{let Q=await A.getSettings();if(Q.settings)this.settingsCache=Q.settings,this.names=Q.settings.inverter_names??{}}catch{}}async fetchOverlays(){try{let Q=await A.overlays(),Y={};for(let G of Q)for(let X of G.uids)Y[X]=G.id;this.customProfiles=Y}catch{}}onRename=async(Q)=>{let{uid:Y,name:G}=Q.detail,X=this.settingsCache??{ecu_id:"",mac:"",pan_override:"",zigbee_type:""},K={...X.inverter_names??{}};if(G.trim())K[Y]=G.trim();else delete K[Y];let B={...X,inverter_names:K};try{await A.saveSettings(B),this.settingsCache=B,this.names=K}catch{}};stopStreams(){if(this.closeSSE?.(),this.closeSSE=null,this.sysTimer)clearInterval(this.sysTimer);this.sysTimer=null}activeView(){switch(this.route){case"inverters":return q`<inverters-view
          .fleet=${this.fleet}
          .names=${this.names}
