...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:Q,strings:Y,values:G}},q=G3(uQ),S=G3(w4),m8=G3(T4),n=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),x3=new WeakMap,l=d.createTreeWalker(d,129),i=b4;function c3(Q,Y){if(!e4(Q)||!Q.hasOwnProperty("raw")){let G="invalid template strings array";throw G=`
...
`),Error(G)}return w3!==void 0?w3.createHTML(Y):Y}var lQ=(Q,Y)=>{let G=Q.length-1,X=[],K=Y===w4?"<svg>":Y===T4?"<math>":"",B,J=W4;for(let U=0;U<G;U++){let W=Q[U],j=-1,D,I=0,F;while(I<W.length){if(J.lastIndex=I,F=J.exec(W),F===null)break;if(I=J.lastIndex,J===W4){if(F[T3]==="!--")J=S3;else if(F[T3]!==void 0)J=b3;else if(F[i4]!==void 0){if(h3.test(F[i4]))B=new RegExp(`</${F[i4]}`,"g");J=r}else if(F[cQ]!==void 0)throw Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else if(J===r)if(F[yQ]===">")J=B??W4,j=-1;else if(F[C3]===void 0)j=-2;else j=J.lastIndex-F[mQ].length,D=F[C3],J=F[k3]===void 0?r:F[k3]==='"'?t4:s4;else if(J===t4||J===s4)J=r;else if(J===S3||J===b3)J=W4;else J=r,B=void 0}console.assert(j===-1||J===r||J===s4||J===t4,"unexpected parse state B");let P=J===r&&Q[U+1].startsWith("/>")?" ":"";K+=J===W4?W+xQ:j>=0?(X.push(D),W.slice(0,j)+g3+W.slice(j))+c+P:W+c+(j===-2?U:P)}let H=K+(Q[G]||"<?>")+(Y===w4?"</svg>":Y===T4?"</math>":"");return[c3(Q,H),X]};class D4{constructor({strings:Q,["_$litType$"]:Y},G){this.parts=[];let X,K=0,B=0,J=Q.length-1,H=this.parts,[U,W]=lQ(Q,Y);if(this.el=D4.createElement(U,G),l.currentNode=this.el.content,Y===w4||Y===T4){let j=this.el.content.firstChild;j.replaceWith(...j.childNodes)}while((X=l.nextNode())!==null&&H.length<J){if(X.nodeType===1){{let j=X.localName;if(/^(?:textarea|template)$/i.test(j)&&X.innerHTML.includes(c)){let D=`Expressions are not supported inside \`${j}\` elements. See https://lit.dev/msg/expression-in-${j} for more information.`;if(j==="template")throw Error(D);else j4("",D)}}if(X.hasAttributes()){for(let j of X.getAttributeNames())if(j.endsWith(g3)){let D=W[B++],F=X.getAttribute(j).split(c),P=/([.?@])?(.*)/.exec(D);H.push({type:Q3,index:K,name:P[2],strings:F,ctor:P[1]==="."?m3:P[1]==="?"?u3:P[1]==="@"?f3:F4}),X.removeAttribute(j)}else if(j.startsWith(c))H.push({type:Y3,index:K}),X.removeAttribute(j)}if(h3.test(X.tagName)){let j=X.textContent.split(c),D=j.length-1;if(D>0){X.textContent=_4?_4.emptyScript:"";for(let I=0;I<D;I++)X.append(j[I],$4()),l.nextNode(),H.push({type:S4,index:++K});X.append(j[D],$4())}}}else if(X.nodeType===8)if(X.data===v3)H.push({type:S4,index:K});else{let D=-1;while((D=X.data.indexOf(c,D+1))!==-1)H.push({type:pQ,index:K}),D+=c.length-1}K++}if(W.length!==B)throw Error('Detected duplicate attribute bindings. This occurs if your template has duplicate attributes on an element tag. For example "<input ?disabled=${true} ?disabled=${false}>" contains a duplicate "disabled" attribute. The error was detected in the following template: \n`'+Q.join("${...}")+"`");V&&V({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:Q})}static createElement(Q,Y){let G=d.createElement("template");return G.innerHTML=Q,G}}function e(Q,Y,G=Q,X){if(Y===n)return Y;let K=X!==void 0?G.__directives?.[X]:G.__directive,B=A4(Y)?void 0:Y._$litDirective$;if(K?.constructor!==B){if(K?._$notifyDirectiveConnectionChanged?.(!1),B===void 0)K=void 0;else K=new B(Q),K._$initialize(Q,G,X);if(X!==void 0)(G.__directives??=[])[X]=K;else G.__directive=K}if(K!==void 0)Y=e(Q,K._$resolve(Q,Y.values),K,X);return Y}class y3{constructor(Q,Y){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=Q,this._$parent=Y}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(Q){let{el:{content:Y},parts:G}=this._$template,X=(Q?.creationScope??d).importNode(Y,!0);l.currentNode=X;let K=l.nextNode(),B=0,J=0,H=G[0];while(H!==void 0){if(B===H.index){let U;if(H.type===S4)U=new L4(K,K.nextSibling,this,Q);else if(H.type===Q3)U=new H.ctor(K,H.name,H.strings,this,Q);else if(H.type===Y3)U=new o3(K,this,Q);this._$parts.push(U),H=G[++J]}if(B!==H?.index)K=l.nextNode(),B++}return l.currentNode=d,X}_update(Q){let Y=0;for(let G of this._$parts){if(G!==void 0)if(V&&V({kind:"set part",part:G,value:Q[Y],valueIndex:Y,values:Q,templateInstance:this}),G.strings!==void 0)G._$setValue(Q,G,Y),Y+=G.strings.length-2;else G._$setValue(Q[Y]);Y++}}}class L4{get _$isConnected(){return this._$parent?._$isConnected??this.__isConnected}constructor(Q,Y,G,X){this.type=S4,this._$committedValue=z,this._$disconnectableChildren=void 0,this._$startNode=Q,this._$endNode=Y,this._$parent=G,this.options=X,this.__isConnected=X?.isConnected??!0,this._textSanitizer=void 0}get parentNode(){let Q=k(this._$startNode).parentNode,Y=this._$parent;if(Y!==void 0&&Q?.nodeType===11)Q=Y.parentNode;return Q}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(Q,Y=this){if(this.parentNode===null)throw Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(Q=e(this,Q,Y),A4(Q)){if(Q===z||Q==null||Q===""){if(this._$committedValue!==z)V&&V({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear();this._$committedValue=z}else if(Q!==this._$committedValue&&Q!==n)this._commitText(Q)}else if(Q._$litType$!==void 0)this._commitTemplateResult(Q);else if(Q.nodeType!==void 0){if(this.options?.host===Q){this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),console.warn("Attempted to render the template host",Q,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");return}this._commitNode(Q)}else if(gQ(Q))this._commitIterable(Q);else this._commitText(Q)}_insert(Q){return k(k(this._$startNode).parentNode).insertBefore(Q,this._$endNode)}_commitNode(Q){if(this._$committedValue!==Q){if(this._$clear(),i!==b4){let Y=this._$startNode.parentNode?.nodeName;if(Y==="STYLE"||Y==="SCRIPT"){let G="Forbidden";if(Y==="STYLE")G="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.";else G="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.";throw Error(G)}}V&&V({kind:"commit node",start:this._$startNode,parent:this._$parent,value:Q,options:this.options}),this._$committedValue=this._insert(Q)}}_commitText(Q){if(this._$committedValue!==z&&A4(this._$committedValue)){let Y=k(this._$startNode).nextSibling;if(this._textSanitizer===void 0)this._textSanitizer=a4(Y,"data","property");Q=this._textSanitizer(Q),V&&V({kind:"commit text",node:Y,value:Q,options:this.options}),Y.data=Q}else{let Y=d.createTextNode("");if(this._commitNode(Y),this._textSanitizer===void 0)this._textSanitizer=a4(Y,"data","property");Q=this._textSanitizer(Q),V&&V({kind:"commit text",node:Y,value:Q,options:this.options}),Y.data=Q}this._$committedValue=Q}_commitTemplateResult(Q){let{values:Y,["_$litType$"]:G}=Q,X=typeof G==="number"?this._$getTemplate(Q):(G.el===void 0&&(G.el=D4.createElement(c3(G.h,G.h[0]),this.options)),G);if(this._$committedValue?._$template===X)V&&V({kind:"template updating",template:X,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:Y}),this._$committedValue._update(Y);else{let K=new y3(X,this),B=K._clone(this.options);V&&V({kind:"template instantiated",template:X,instance:K,parts:K._$parts,options:this.options,fragment:B,values:Y}),K._update(Y),V&&V({kind:"template instantiated and updated",template:X,instance:K,parts:K._$parts,options:this.options,fragment:B,values:Y}),this._commitNode(B),this._$committedValue=K}}_$getTemplate(Q){let Y=x3.get(Q.strings);if(Y===void 0)x3.set(Q.strings,Y=new D4(Q));return Y}_commitIterable(Q){if(!e4(this._$committedValue))this._$committedValue=[],this._$clear();let Y=this._$committedValue,G=0,X;for(let K of Q){if(G===Y.length)Y.push(X=new L4(this._insert($4()),this._insert($4()),this,this.options));else X=Y[G];X._$setValue(K),G++}if(G<Y.length)this._$clear(X&&k(X._$endNode).nextSibling,G),Y.length=G}_$clear(Q=k(this._$startNode).nextSibling,Y){this._$notifyConnectionChanged?.(!1,!0,Y);while(Q!==this._$endNode){let G=k(Q).nextSibling;k(Q).remove(),Q=G}}setConnected(Q){if(this._$parent===void 0)this.__isConnected=Q,this._$notifyConnectionChanged?.(Q);else throw Error("part.setConnected() may only be called on a RootPart returned from render().")}}class F4{get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}constructor(Q,Y,G,X,K){if(this.type=Q3,this._$committedValue=z,this._$disconnectableChildren=void 0,this.element=Q,this.name=Y,this._$parent=X,this.options=K,G.length>2||G[0]!==""||G[1]!=="")this._$committedValue=Array(G.length-1).fill(new String),this.strings=G;else this._$committedValue=z;this._sanitizer=void 0}_$setValue(Q,Y=this,G,X){let K=this.strings,B=!1;if(K===void 0){if(Q=e(this,Q,Y,0),B=!A4(Q)||Q!==this._$committedValue&&Q!==n,B)this._$committedValue=Q}else{let J=Q;Q=K[0];let H,U;for(H=0;H<K.length-1;H++){if(U=e(this,J[G+H],Y,H),U===n)U=this._$committedValue[H];if(B||=!A4(U)||U!==this._$committedValue[H],U===z)Q=z;else if(Q!==z)Q+=(U??"")+K[H+1];this._$committedValue[H]=U}}if(B&&!X)this._commitValue(Q)}_commitValue(Q){if(Q===z)k(this.element).removeAttribute(this.name);else{if(this._sanitizer===void 0)this._sanitizer=i(this.element,this.name,"attribute");Q=this._sanitizer(Q??""),V&&V({kind:"commit attribute",element:this.element,name:this.name,value:Q,options:this.options}),k(this.element).setAttribute(this.name,Q??"")}}}class m3 extends F4{constructor(){super(...arguments);this.type=fQ}_commitValue(Q){if(this._sanitizer===void 0)this._sanitizer=i(this.element,this.name,"property");Q=this._sanitizer(Q),V&&V({kind:"commit property",element:this.element,name:this.name,value:Q,options:this.options}),this.element[this.name]=Q===z?void 0:Q}}class u3 extends F4{constructor(){super(...arguments);this.type=oQ}_commitValue(Q){V&&V({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(Q&&Q!==z),options:this.options}),k(this.element).toggleAttribute(this.name,!!Q&&Q!==z)}}class f3 extends F4{constructor(Q,Y,G,X,K){super(Q,Y,G,X,K);if(this.type=rQ,this.strings!==void 0)throw Error(`A \`<${Q.localName}>\` has a \`@${Y}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(Q,Y=this){if(Q=e(this,Q,Y,0)??z,Q===n)return;let G=this._$committedValue,X=Q===z&&G!==z||Q.capture!==G.capture||Q.once!==G.once||Q.passive!==G.passive,K=Q!==z&&(G===z||X);if(V&&V({kind:"commit event listener",element:this.element,name:this.name,value:Q,options:this.options,removeListener:X,addListener:K,oldListener:G}),X)this.element.removeEventListener(this.name,this,G);if(K)this.element.addEventListener(this.name,this,Q);this._$committedValue=Q}handleEvent(Q){if(typeof this._$committedValue==="function")this._$committedValue.call(this.options?.host??this.element,Q);else this._$committedValue.handleEvent(Q)}}class o3{constructor(Q,Y,G){this.element=Q,this.type=Y3,this._$disconnectableChildren=void 0,this._$parent=Y,this.options=G}get _$isConnected(){return this._$parent._$isConnected}_$setValue(Q){V&&V({kind:"commit to element binding",element:this.element,value:Q,options:this.options}),e(this,Q)}}var dQ=T.litHtmlPolyfillSupportDevMode;dQ?.(D4,L4);(T.litHtmlVersions??=[]).push("3.3.3");if(T.litHtmlVersions.length>1)queueMicrotask(()=>{j4("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var U4=(Q,Y,G)=>{if(Y==null)throw TypeError(`The container to render into may not be ${Y}`);let X=SQ++,K=G?.renderBefore??Y,B=K._$litPart$;if(V&&V({kind:"begin render",id:X,value:Q,container:Y,options:G,part:B}),B===void 0){let J=G?.renderBefore??null;K._$litPart$=B=new L4(Y.insertBefore($4(),J),J,void 0,G??{})}return B._$setValue(Q),V&&V({kind:"end render",id:X,value:Q,container:Y,options:G,part:B}),B};U4.setSanitizer=CQ,U4.createSanitizer=a4,U4._testOnlyClearSanitizerFactoryDoNotCallOrElse=kQ;var nQ=(Q,Y)=>Q,X3=!0,y=globalThis,r3;if(X3)y.litIssuedWarnings??=new Set,r3=(Q,Y)=>{if(Y+=` See https://lit.dev/msg/${Q} for more information.`,!y.litIssuedWarnings.has(Y)&&!y.litIssuedWarnings.has(Q))console.warn(Y),y.litIssuedWarnings.add(Y)};class $ extends w{constructor(){super(...arguments);this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){let Q=super.createRenderRoot();return this.renderOptions.renderBefore??=Q.firstChild,Q}update(Q){let Y=this.render();if(!this.hasUpdated)this.renderOptions.isConnected=this.isConnected;super.update(Q),this.__childPart=U4(Y,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.__childPart?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.__childPart?.setConnected(!1)}render(){return n}}$._$litElement$=!0;$[nQ("finalized",$)]=!0;y.litElementHydrateSupport?.({LitElement:$});var iQ=X3?y.litElementPolyfillSupportDevMode:y.litElementPolyfillSupport;iQ?.({LitElement:$});(y.litElementVersions??=[]).push("4.2.2");if(X3&&y.litElementVersions.length>1)queueMicrotask(()=>{r3("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var d3=null;function q3(Q){d3=Q}async function sQ(Q,Y){let G=(await Q.text()).trim();if(G){try{let X=JSON.parse(G);if(typeof X?.error==="string"&&X.error)return X.error}catch{}return G}return`${Y}: ${Q.status}`}async function I4(Q,Y){if(Q.ok)return;if(Q.status===401)d3?.();throw Error(await sQ(Q,Y))}async function v(Q){let Y=await fetch(Q,{credentials:"same-origin"});return await I4(Y,Q),await Y.json()}async function K3(Q,Y){let G=await fetch(Q,{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify(Y)});await I4(G,Q)}async function b(Q,Y){let G=await fetch(Q,{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify(Y)});return await I4(G,Q),await G.json()}async function p3(Q,Y){let G=await fetch(Q,{method:"PUT",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify(Y)});return await I4(G,Q),await G.json()}function Q4(Q){if(!Q||!Q.op)return!1;return Q.stage!==""&&Q.stage!=="done"&&Q.stage!=="aborted"&&Q.stage!=="error"}async function l3(Q,Y){let G=await fetch(Q,{method:"DELETE",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify(Y)});return await I4(G,Q),await G.json()}var A={authStatus:()=>v("/api/auth/status"),setup:(Q)=>b("/api/auth/setup",{password:Q}),login:(Q)=>K3("/api/auth/login",{password:Q}),logout:()=>K3("/api/auth/logout",{}),recover:(Q,Y)=>b("/api/auth/recover",{recovery_code:Q,password:Y}),changePassword:(Q,Y)=>K3("/api/auth/change-password",{current_password:Q,new_password:Y}),regenerateRecovery:()=>b("/api/auth/recovery",{}),fleet:()=>v("/api/fleet"),system:()=>v("/api/system"),history:()=>v("/api/history"),events:(Q={})=>{let Y=new URLSearchParams;if(Q.since_ms)Y.set("since_ms",String(Q.since_ms));if(Q.kind)Y.set("kind",Q.kind);if(Q.severity)Y.set("severity",Q.severity);if(Q.inverter_uid)Y.set("inverter_uid",Q.inverter_uid);if(Q.limit)Y.set("limit",String(Q.limit));let G=Y.toString();return v("/api/events"+(G?`?${G}`:""))},getSettings:async()=>{let Q=await v("/api/settings");if(Q.error)return{error:Q.error};return{settings:{ecu_id:Q.ecu_id,mac:Q.mac,pan_override:Q.pan_override,zigbee_type:Q.zigbee_type,channel:Q.channel,inverter_names:Q.inverter_names??{}}}},saveSettings:(Q)=>p3("/api/settings",Q),verifyPassword:async(Q)=>{let Y=await fetch("/api/auth/verify",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:Q})});if(Y.status===200)return!0;if(Y.status===401)return!1;let G=await Y.text();throw Error(G.trim()||`/api/auth/verify: ${Y.status}`)},setPower:(Q)=>b("/api/power",Q),profiles:()=>v("/api/profiles"),overlays:()=>v("/api/overlays"),selectBase:(Q)=>b("/api/profiles/base",{id:Q}),saveOverlay:(Q)=>p3("/api/profiles/overlay",Q),deleteOverlay:(Q,Y)=>l3("/api/profiles/overlay",{id:Q,uids:Y}),pairingScan:(Q={})=>b("/api/pairing/scan",Q),pairingAdd:(Q)=>b("/api/pairing/add",{serial:Q}),pairingReplace:(Q,Y)=>b("/api/pairing/replace",{old_uid:Q,new_serial:Y}),pairingRekey:(Q,Y=0)=>b("/api/pairing/rekey",{new_pan:Q,channel:Y}),pairingChangeChannel:(Q)=>b("/api/pairing/change-channel",{channel:Q}),pairingRemove:(Q,Y)=>b("/api/inverters/remove",{serial:Q,force:Y}),pairingAbort:()=>b("/api/pairing/abort",{}),pairingStatus:()=>v("/api/pairing/status"),sshKeys:()=>v("/api/access/ssh-keys"),addSshKey:(Q,Y)=>b("/api/access/ssh-keys",{pubkey:Q,comment:Y}),removeSshKey:(Q)=>l3("/api/access/ssh-keys",{fingerprint:Q})};function n3(Q,Y){let G=new EventSource("/api/stream");return G.addEventListener("fleet",(X)=>{try{Q(JSON.parse(X.data))}catch{}}),G.onerror=()=>Y?.(),()=>G.close()}class i3 extends ${static properties={configured:{type:Boolean},error:{state:!0},busy:{state:!0},recoverMode:{state:!0},savedCode:{state:!0},copied:{state:!0}};constructor(){super();this.configured=!0,this.error="",this.busy=!1,this.recoverMode=!1,this.savedCode="",this.copied=!1}static styles=L`
  ...
  `;firstUpdated(){this.focusFirst()}updated(Q){if(Q.has("recoverMode")||Q.has("savedCode"))this.focusFirst()}focusFirst(){this.renderRoot.querySelector("input")?.focus()}val(Q){return this.renderRoot.querySelector(`#${Q}`)?.value??""}async submit(Q){if(Q.preventDefault(),this.busy)return;this.error="";let Y=!this.configured,G=this.configured&&this.recoverMode;if(Y||G){if(this.val("pw")!==this.val("pw2")){this.error="Passwords do not match.";return}}this.busy=!0;try{if(Y){let X=await A.setup(this.val("pw"));this.savedCode=X.recovery_code}else if(G){let X=await A.recover(this.val("code"),this.val("pw"));this.savedCode=X.recovery_code}else await A.login(this.val("pw")),this.done()}catch(X){this.error=X.message||"failed"}finally{this.busy=!1}}done(){this.dispatchEvent(new CustomEvent("authed",{bubbles:!0,composed:!0}))}async copyCode(){try{await navigator.clipboard?.writeText(this.savedCode),this.copied=!0}catch{}}render(){if(this.savedCode)return this.renderSaved();let Q=!this.configured,Y=this.configured&&this.recoverMode,G=Y?"Reset password":"ECU Console",X=Q?"First run — choose an operator password (min 8 characters).":Y?"Enter your recovery code and a new password.":"Enter the operator password.";return q`
    ...
    `}}customElements.define("login-view",i3);function Z(Q){if(!Number.isFinite(Q))return"";return String(Number(Q.toFixed(3)))}function M(Q){if(!Number.isFinite(Q))return"—";if(Math.abs(Q)>=1000)return`${(Q/1000).toFixed(2)} kW`;return`${Math.round(Q)} W`}function V4(Q){if(!Number.isFinite(Q))return"—";let Y=Math.abs(Q);if(Y>=1e6)return`${(Q/1e6).toFixed(2)} MWh`;if(Y>=1000)return`${(Q/1000).toFixed(2)} kWh`;return`${Math.round(Q)} Wh`}function Y4(Q){return Number.isFinite(Q)?`${Q.toFixed(0)}%`:"—"}function N4(Q){return Q>0?`${Q.toFixed(1)} V`:"—"}function C4(Q){return Q>0?`${Q.toFixed(2)} Hz`:"—"}function s3(Q){return Number.isFinite(Q)?`${Q.toFixed(2)} A`:"—"}function k4(Q){if(!(Q>0))return"idle";if(Q<40)return"low";if(Q<85)return"mid";return"high"}function t3(Q){if(!Number.isFinite(Q)||Q<0)return"—";if(Q<60)return`${Math.round(Q)}s ago`;if(Q<3600)return`${Math.round(Q/60)}m ago`;return`${Math.round(Q/3600)}h ago`}function B3(Q){return Q.replace(/_/g," ").replace(/\b\w/g,(Y)=>Y.toUpperCase())}function x4(Q){if(!Q)return[];return Object.keys(Q).filter((Y)=>Q[Y]).map(B3)}function G4(Q){if(!Q)return"—";return new Date(Q).toLocaleString(void 0,{hour12:!1})}function a3(Q){let Y=(Q||"").toLowerCase();if(Y==="error"||Y==="critical"||Y==="crit"||Y==="fault")return"err";if(Y==="warn"||Y==="warning")return"warn";return"info"}function h(Q){return Q.nameplate_w||0}function X4(Q){return Math.round(h(Q)*20/500)}function K4(Q){let Y=Q.protection?.DA;if(Y==null)return;return Math.round(Y/500*h(Q))}class e3 extends ${static properties={power:{type:Number},cap:{type:Number}};constructor(){super();this.power=0,this.cap=0}static styles=L`
  ...
  `;pct(){if(!(this.cap>0))return 0;return Math.max(0,Math.min(100,this.power/this.cap*100))}render(){let Q=this.pct(),Y=k4(Q),G=90,X=Math.PI*90,K=X*(1-Q/100);return q`
      <div class="wrap">
  ...
  `;render(){let Q=this.inverter;if(!Q)return z;let Y=x4(Q.faults);return q`
      <div class="head">
        <div>
      ...
      <div class="metrics">
        ...
        <div class="metric"><div class="k">Freq</div><div class="v">${C4(Q.freq_hz)}</div></div>
  ...
  `;idRow(Q,Y){return Y?q`<div class="k">${Q}</div><div class="v">${Y}</div>`:z}clients(){let Q=new Map;for(let Y of this.system?.peers??[]){let G=Q.get(Y.backend)??{backend:Y.backend,version:Y.version,controller:!1,conns:0};if(G.conns++,G.controller=G.controller||Y.controller,Y.version)G.version=Y.version;Q.set(Y.backend,G)}return[...Q.values()].sort((Y,G)=>Y.backend.localeCompare(G.backend))}render(){let Q=this.system,Y=Q?.ecu,G=this.clients(),X=!!(Y&&(Y.ecu_id||Y.hostname));return q`
    ...
    `}}customElements.define("ecu-clients-card",X9);function tQ(Q,Y,G){if(Q.length<2)return{line:"",area:"",max:0};let X=Q[0].t,K=Math.max(1,Q[Q.length-1].t-X),B=Math.max(1,...Q.map((D)=>D.w)),J=(D)=>[(D.t-X)/K*Y,G-D.w/B*G],H="";for(let D=0;D<Q.length;D++){let[I,F]=J(Q[D]);H+=`${D===0?"M":"L"}${I.toFixed(1)} ${F.toFixed(1)} `}let[U]=J(Q[0]),[W]=J(Q[Q.length-1]),j=`${H}L${W.toFixed(1)} ${G} L${U.toFixed(1)} ${G} Z`;return{line:H.trim(),area:j,max:B}}var g4=600,O4=160;class K9 extends ${static properties={points:{attribute:!1},hoverIdx:{state:!0}};constructor(){super();this.points=[],this.hoverIdx=-1}static styles=L`
    :host { display: block; }
  ...
  `;onMove=(Q)=>{let Y=this.points.length;if(Y<2)return;let X=Q.currentTarget.clientWidth||1,K=Math.min(1,Math.max(0,Q.offsetX/X));this.hoverIdx=Math.round(K*(Y-1))};onLeave=()=>{this.hoverIdx=-1};render(){let Q=this.points??[];if(Q.length<2)return q`<div class="empty">Collecting power history…</div>`;let{line:Y,area:G,max:X}=tQ(Q,g4,O4),K=Q[Q.length-1].w,B=this.hoverIdx,J=B>=0&&B<Q.length,H=Q[0].t,U=Math.max(1,Q[Q.length-1].t-H),W=J?(Q[B].t-H)/U*g4:0,j=J?O4-Q[B].w/X*O4:0;return q`
      <div class="wrap">
        <svg
          viewBox="0 0 ${g4} ${O4}"
        ...
        ${J?q`<div class="tip" style="left:${W/g4*100}%; top:${j}px">
...
Enter the replacement's 12-digit serial, or leave blank to scan for it. The new unit inherits this one's grid profile, power cap and array slot.`);if(Y===null)return;let G=Y.replace(/\D/g,"");if(G!==""&&G.length!==12){this.notice="Replacement serial must be 12 digits (or blank to scan).";return}this.busy=!0,this.notice="";try{let X=await A.pairingReplace(Q,G);if(!X.ok)throw Error(X.error||"replace rejected");this.applyResp(X.status)}catch(X){this.notice=String(X.message||X)}finally{this.busy=!1}};onRekey=()=>{this.notice="",this.privilegedError="",this.privilegedDialog="rekey"};onChangeChannel=()=>{this.notice="",this.privilegedError="",this.privilegedDialog="channel"};onRemove=(Q)=>{this.notice="",this.privilegedError="",this.removeUid=Q,this.privilegedDialog="remove"};onPrivilegedCancel=()=>{if(this.busy)return;this.privilegedDialog="",this.privilegedError="",this.removeUid=""};onPrivilegedConfirm=async(Q)=>{let Y=this.privilegedDialog;if(!Y)return;let{value:G,force:X}=Q.detail;this.busy=!0,this.privilegedError="",this.notice="";try{let K;if(Y==="rekey")K=await A.pairingRekey(G,0);else if(Y==="channel")K=await A.pairingChangeChannel(Number(G));else K=await A.pairingRemove(this.removeUid,X??!1);if(!K.ok){let B=K.error||(Y==="rekey"?"re-key rejected":Y==="channel"?"channel change rejected":"remove rejected");throw Error(B)}this.privilegedDialog="",this.privilegedError="",this.removeUid="",this.applyResp(K.status)}catch(K){this.privilegedError=String(K.message||K)}finally{this.busy=!1}};onAbort=async()=>{this.aborting=!0;try{let Q=await A.pairingAbort();this.status=Q.status??this.status}catch(Q){this.notice=String(Q.message||Q)}finally{this.aborting=!1,this.fetchStatus()}};onCloseDrawer=()=>{if(Q4(this.status))return;this.drawerOpen=!1};static styles=L`
  ...
  `;connectedCallback(){super.connectedCallback(),this.loadRecent(),this.timer=setInterval(()=>void this.loadRecent(),Q8)}disconnectedCallback(){if(super.disconnectedCallback(),this.timer)clearInterval(this.timer),this.timer=null}updated(Q){if(Q.has("fleet"))this.loadRecent()}async loadRecent(){this.recentLoading=!0;try{let Q=await A.events({kind:"fault_raised",since_ms:Date.now()-Y8,limit:G8});this.recent=Q.events??[],this.recentError=Q.error??""}catch(Q){this.recentError=Q.message||"failed to load events"}finally{this.recentLoading=!1}}alarms(){let Q=[];for(let Y of this.fleet?.inverters??[]){for(let G of x4(Y.faults))Q.push({uid:Y.uid,model:Y.model,label:G,severity:"fault"});if(!Y.online)Q.push({uid:Y.uid,model:Y.model,label:"Inverter offline",severity:"warning"})}return Q}renderLive(){let Q=this.alarms();if(Q.length===0)return q`<div class="ok"><div class="big">✓ No active alarms</div><div>All inverters reporting healthy.</div></div>`;return q`${Q.map((Y)=>q`<div class="row ${Y.severity}">
